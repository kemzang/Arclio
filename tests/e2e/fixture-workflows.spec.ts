...
test('Electron bulk metadata concurrency and back/next navigation reach completed queue files', async () => {
  ...
  await withFixtureProductApp(
    {
      behavior: { metadataDelayMs: 2_000 },
      userDataPrefix: 'arroxy-fixture-electron-user-',
      outputPrefix: 'arroxy-fixture-electron-out-'
    },
    async ({ app, page, fixtureServer, urls, files }) => {
