...
const baseCtx: StepContext = {activePreset: null, wizardMode: 'single', playlistSelection: null, wizardExtractor: '', hasSubtitles: false}
...
const baseNavCtx: NavContext = {activePreset: null, wizardMode: 'single', playlistSelection: null, wizardExtractor: '', hasSubtitles: false, wizardSubtitleSkipped: false}
