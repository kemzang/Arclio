...
describe('RuntimeBinaryTrust', () => {
	it('fetches signed runtime metadata from the dedicated runtime release repo', () => {
		expect(RUNTIME_BINARY_INDEX_URL).toBe('https://github.com/kemzang/arclio-runtime-binaries/releases/latest/download/runtime-index-v1.json')
		expect(RUNTIME_BINARY_INDEX_SIGNATURE_URL).toBe('https://github.com/kemzang/arclio-runtime-binaries/releases/latest/download/runtime-index-v1.sig')
