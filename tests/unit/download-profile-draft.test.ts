...
describe('DownloadProfileDraft', () => {
	it('initializes from a built-in profile', () => {
		...
		expect(draft).toMatchObject({profileId: 'balanced', profileName: 'Balanced 720p', profileIcon: 'controls', mediaMode: 'video-audio', codec: 'best', resolution: '720', audioFormat: 'best', subfolderName: 'Arclio'})
	})
