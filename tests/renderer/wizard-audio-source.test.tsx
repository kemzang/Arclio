...
function buildPlaylistProbe(extractor: string, isAudioOnlySource: boolean): ProbeResult {
	return {kind: 'playlist', extractor, extractorKey: extractor, webpageUrl: 'https://example.com/p', isAudioOnlySource, isMultiVideo: false, playlistId: 'p1', playlistTitle: 'Playlist', entries: [{id: 'e1', url: 'https://example.com/e1', title: 'Entry 1', thumbnail: '', playlistIndex: 1, videoId: 'e1'}]}
}
