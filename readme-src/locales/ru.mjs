...
export const ru = {
  ...
  cta_website: "Сайт",
  demo_alt: "Демо Arclio",
  star_cta: "Если Arclio экономит вам время — ⭐ поможет другим его найти.",
  ai_notice:
  ...
  dl_macos_warning:
    "Arclio пока не подписан кодом, поэтому macOS Gatekeeper покажет предупреждение при первом запуске. Это ожидаемо — признаком повреждения это не является.",
  dl_macos_m1_h4: "Способ через Системные настройки (рекомендуется):",
  dl_macos_step1:
    "Кликните правой кнопкой по иконке Arclio и выберите **Открыть**.",
  dl_macos_step2:
  ...
  dl_macos_step4:
    "Прокрутите до раздела **Безопасность** — увидите *«Arclio заблокирован, так как разработчик не идентифицирован»*.",
  dl_macos_step5:
    "Нажмите **Открыть всё равно** и подтвердите паролем или Touch ID.",
  dl_macos_after:
    "После шага 5 Arclio открывается как обычно, и предупреждение больше не появится.",
  ...
  dl_macos_sequoia_step1:
    "Перетащите `Arclio.app` из смонтированного DMG в `/Applications`.",
  dl_macos_sequoia_step2:
    "Дважды кликните Arclio. Появится диалог блокировки — нажмите **Done** (не нажимайте *Move to Trash*).",
  dl_macos_sequoia_step3:
    'Откройте **System Settings → Privacy & Security** и прокрутите до раздела **Security**. Вы увидите *"Arclio was blocked to protect your Mac"* (или аналогичное сообщение).',
  dl_macos_sequoia_step4:
    "Нажмите **Open Anyway**, подтвердите паролем или Touch ID, затем снова запустите Arclio из `/Applications`.",
  dl_macos_sonoma_h4: "macOS Sonoma 14 и старше",
  dl_macos_sonoma_step1:
    "Перетащите `Arclio.app` из смонтированного DMG в `/Applications`.",
  dl_macos_sonoma_step2:
    "Кликните правой кнопкой (или Control-кликните) `Arclio.app` в `/Applications` и выберите **Open**.",
  dl_macos_sonoma_step3:
    "В диалоге предупреждения теперь есть кнопка **Open** — нажмите её и подтвердите. Arclio откроется в штатном режиме, и предупреждение больше не появится.",
  dl_macos_damaged_h4:
  ...
  faq_q6: "На каких языках доступен Arclio?",
  faq_a6:
  ...
  plan_r6_desc:
    "Открывать браузерные окна внутри Arclio, чтобы входить на сайты и использовать cookies без ручного экспорта",
