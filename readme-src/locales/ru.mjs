...
export const ru = {
  ...
  title: "Arroxy — бесплатный загрузчик YouTube (+ 2000 сайтов) с открытым исходным кодом для Windows, macOS и Linux",
  read_in_label: "Язык:",
  ...
  plan_r1_desc: "Фильтры по диапазону дат при перечислении плейлиста или канала",
