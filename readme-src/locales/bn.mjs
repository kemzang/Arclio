...
export const bn = {
  ...
  feat_quality_3:
    "**অডিও নিয়ন্ত্রণ** — শুধু অডিও MP3, M4A/AAC, Opus বা WAV হিসেবে এক্সপোর্ট করুন; গ্লোবাল **সারাউন্ড / Dolby অগ্রাধিকার দিন** অপশন সেট করুন; এবং উপলভ্য হলে ইন্টারঅ্যাক্টিভ ডাউনলোডে নেটিভ Dolby AC-3/EC-3, মাল্টিচ্যানেল, DRC ও অন্যান্য উন্নত অডিও ট্র্যাক নির্বাচনযোগ্য রাখুন",
