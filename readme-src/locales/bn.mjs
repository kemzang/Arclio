...
export const bn = {
  ...
  title: "Arroxy — Windows, macOS ও Linux-এর জন্য বিনামূল্যে ওপেন-সোর্স YouTube (+ ২০০০ সাইট) ডাউনলোডার",
  read_in_label: "পড়ুন:",
  ...
  feat_workflow_1:
    "**যেকোনো লিঙ্ক পেস্ট করুন** — YouTube ভিডিও, Shorts, চ্যানেল, প্লেলিস্ট, পডকাস্ট ও Music, এবং yt-dlp সমর্থিত ২০০০+ অন্যান্য সাইট; পুরো playlist ডাউনলোড করুন বা আগে নির্দিষ্ট ভিডিও বেছে নিন",
  feat_workflow_2:
  ...
  feat_workflow_8:
    "**সতর্ক মোড** — কনফিগারযোগ্য পেসিং প্রিসেট (*বন্ধ · ভারসাম্যপূর্ণ · সতর্ক · কাস্টম*) যা অনুরোধের মাঝে বিলম্ব যোগ করে এবং ফ্র্যাগমেন্ট থ্রেড সীমিত করে, বড় প্লেলিস্টে bot-block হওয়ার ঝুঁকি কমায়",
  ...
  faq_a8:
    "হ্যাঁ — উভয়ই। একটি playlist URL বা channel URL পেস্ট করুন (যেমন `youtube.com/@handle`, `/channel/UC…`, `/c/Name`, `/user/Old`); Arroxy সর্বোচ্চ ৫০০টি এন্ট্রি গণনা করে, তারপর পুরো তালিকা queue করুন বা নির্দিষ্ট ভিডিও বেছে নিন। তারিখ-পরিসর ও সংখ্যার ফিল্টার শীঘ্রই আসছে।",
  ...
  plan_r1_desc:
    "প্লেলিস্ট বা চ্যানেল গণনা করার সময় তারিখ-পরিসর ও সংখ্যার ফিল্টার (আজ ক্যাপ হলো একটি নির্দিষ্ট ৫০০ এন্ট্রি)",
