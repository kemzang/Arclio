...
export const sr = {
  ...
  demo_alt: "Arclio демонстрација",
  star_cta: "Ако вам Arclio уштеди времена, ⭐ помаже другима да га пронађу.",
  ai_notice: "",
  toc_heading: "Садржај",
  why_h2: "Зашто Arclio",
  ...
  dl_macos_warning:
    "Arclio још увек није потписан кодом, па ће macOS Gatekeeper упозорити вас при првом покретању. То је очекивано — није знак оштећења.",
  dl_macos_m1_h4: "Метода системских подешавања (препоручено):",
  dl_macos_step1:
    "Кликните десним тастером на иконицу Arclio апликације и изаберите **Отвори**.",
  dl_macos_step2:
  ...
  dl_macos_step4:
    'Скролујте до одељка **Безбедност**. Видећете *"Arclio је блокиран јер није од идентификованог програмера."*',
  dl_macos_step5:
    "Кликните **Свеједно отвори** и потврдите лозинком или Touch ID-ом.",
  dl_macos_after:
    "Након корака 5, Arclio се отвара нормално и упозорење се више никад не приказује.",
  ...
  dl_macos_sequoia_step1:
    "Превуците `Arclio.app` са монтираног DMG у `/Applications`.",
  dl_macos_sequoia_step2:
    "Двокликните Arclio. Приказује се дијалог блокирања — кликните **Done** (не кликајте *Move to Trash*).",
  dl_macos_sequoia_step3:
    'Отворите **System Settings → Privacy & Security** и скролујте до одељка **Security**. Видећете *"Arclio was blocked to protect your Mac"* (или сличну поруку).',
  dl_macos_sequoia_step4:
    "Кликните **Open Anyway**, потврдите лозинком или Touch ID-ом, а затим поново покрените Arclio из `/Applications`.",
  dl_macos_sonoma_h4: "macOS Sonoma 14 и старије",
  dl_macos_sonoma_step1:
    "Превуците `Arclio.app` са монтираног DMG у `/Applications`.",
  dl_macos_sonoma_step2:
    "Десним кликом (или Control-кликом) кликните на `Arclio.app` у `/Applications` и одаберите **Open**.",
  dl_macos_sonoma_step3:
    "Дијалог упозорења сада има дугме **Open** — кликните га и потврдите. Arclio се отвара нормално и упозорење се никад више не приказује.",
  dl_macos_damaged_h4:
  ...
  faq_q6: "На којим је језицима Arclio доступан?",
  faq_a6:
  ...
  plan_r6_desc:
    "Отварање browser windows унутар Arclio-ја за пријаву и коришћење site cookies без ручног export-а",
