...
export const uk = {
  ...
  star_cta: "Якщо Arclio економить ваш час, ⭐ допомагає іншим його знайти.",
  ai_notice:
  ...
  dl_macos_warning:
    "Arclio ще не підписаний кодом, тому macOS Gatekeeper попередить вас при першому запуску. Це очікувано — не ознака пошкодження.",
  dl_macos_m1_h4: "Спосіб через Системні параметри (рекомендовано):",
  dl_macos_step1:
    "Клацніть правою кнопкою по іконці Arclio і виберіть **Відкрити**.",
  dl_macos_step2:
  ...
  dl_macos_step4:
    'Прокрутіть до розділу **Безпека**. Ви побачите *"Arclio заблоковано, бо він не від ідентифікованого розробника."*',
  dl_macos_step5:
    "Натисніть **Усе одно відкрити** і підтвердіть паролем або Touch ID.",
  dl_macos_after:
    "Після кроку 5 Arclio відкривається нормально і попередження більше не з'являється.",
  ...
  dl_macos_sequoia_step1:
    "Перетягніть `Arclio.app` зі змонтованого DMG до `/Applications`.",
  dl_macos_sequoia_step2:
    "Двічі клацніть Arclio. З'явиться вікно блокування — натисніть **Done** (не натискайте *Move to Trash*).",
  dl_macos_sequoia_step3:
    'Відкрийте **System Settings → Privacy & Security** і прокрутіть до розділу **Security**. Ви побачите *"Arclio was blocked to protect your Mac"* (або схоже повідомлення).',
  dl_macos_sequoia_step4:
    "Натисніть **Open Anyway**, підтвердьте паролем або Touch ID, а потім знову запустіть Arclio з `/Applications`.",
  dl_macos_sonoma_h4: "macOS Sonoma 14 і старіші",
  dl_macos_sonoma_step1:
    "Перетягніть `Arclio.app` зі змонтованого DMG до `/Applications`.",
  dl_macos_sonoma_step2:
    "Клацніть правою кнопкою (або Control-клік) на `Arclio.app` у `/Applications` і виберіть **Open**.",
  dl_macos_sonoma_step3:
    "У вікні попередження тепер є кнопка **Open** — натисніть її і підтвердіть. Arclio відкриється в штатному режимі, і попередження більше не з'являтиметься.",
  dl_macos_damaged_h4:
  ...
  faq_q6: "Якими мовами доступний Arclio?",
  faq_a6:
  ...
  plan_r6_desc:
    "Відкривати браузерні вікна всередині Arclio, щоб входити на сайти й використовувати cookies без ручного експорту",
