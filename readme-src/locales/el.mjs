...
export const el = {
  ...
  feat_quality_3: "**Μόνο ήχος** σε MP3, M4A/AAC, Opus ή WAV",
  ...
  plan_r1_desc:
    "Φίλτρα εύρους ημερομηνιών και πλήθους κατά την απαρίθμηση playlist ή καναλιού (σήμερα το όριο είναι σταθερές 500 καταχωρήσεις)",
