...
export const el = {
  ...
  faq_a3: "Ναι. Επίλεξε *μόνο ήχος* στο μενού μορφής και μετά MP3, M4A/AAC, Opus ή WAV.",
  ...
  plan_r1_desc: "Φίλτρα εύρους ημερομηνιών κατά την απαρίθμηση playlist ή καναλιού",
