...
export const ar = {
  ...
  demo_alt: "عرض توضيحي لـ Arclio",
  star_cta: "إذا وفّر لك Arclio الوقت، فإن ⭐ يساعد الآخرين على اكتشافه.",
  ai_notice: "",
  ...
  dl_macos_warning:
    "Arclio غير موقَّع رمزياً بعد، لذا سيحذّرك Gatekeeper في macOS عند التشغيل الأول. هذا متوقع — وليس دليلاً على تلف.",
  dl_macos_m1_h4: "طريقة إعدادات النظام (مُوصى بها):",
  dl_macos_step1:
    "انقر بزر الماوس الأيمن على أيقونة تطبيق Arclio واختر **فتح**.",
  dl_macos_step2:
    "تظهر نافذة التحذير — انقر **إلغاء** (لا تنقر *نقل إلى سلة المهملات*).",
  dl_macos_step3: "افتح **إعدادات النظام ← الخصوصية والأمان**.",
  dl_macos_step4:
    'مرِّر إلى قسم **الأمان**. ستجد *"تم حظر Arclio لأنه ليس من مطوّر معروف."*',
  dl_macos_step5: "انقر **فتح على أي حال** وأكِّد بكلمة المرور أو Touch ID.",
  dl_macos_after:
    "بعد الخطوة 5، يفتح Arclio بشكل طبيعي ولن يظهر التحذير مجدداً.",
  ...
  dl_macos_sequoia_step1:
    "اسحب `Arclio.app` من DMG المثبَّت إلى `/Applications`.",
  dl_macos_sequoia_step2:
    "انقر مزدوجاً على Arclio. تظهر نافذة الحظر — انقر **Done** (لا تنقر *Move to Trash*).",
  dl_macos_sequoia_step3:
    'افتح **System Settings → Privacy & Security** ومرِّر إلى قسم **Security**. ستجد *"Arclio was blocked to protect your Mac"* (أو رسالة مشابهة).',
  dl_macos_sequoia_step4:
    "انقر **Open Anyway**، أكِّد بكلمة المرور أو Touch ID، ثم أعِد تشغيل Arclio من `/Applications`.",
  dl_macos_sonoma_h4: "macOS Sonoma 14 وما قبله",
  dl_macos_sonoma_step1:
    "اسحب `Arclio.app` من DMG المثبَّت إلى `/Applications`.",
  dl_macos_sonoma_step2:
    "انقر بزر الأيمن (أو Control-click) على `Arclio.app` في `/Applications` واختر **Open**.",
  dl_macos_sonoma_step3:
    "نافذة التحذير تحتوي الآن على زر **Open** — انقره وأكِّد. يفتح Arclio بشكل طبيعي ولن يظهر التحذير مجدداً.",
  dl_macos_damaged_h4:
  ...
  faq_q6: "ما اللغات المتاحة في Arclio؟",
  faq_a6:
  ...
  plan_r6_desc:
    "فتح نوافذ متصفح داخل Arclio لتسجيل الدخول واستخدام cookies الخاصة بالموقع دون تصديرها يدوياً",
