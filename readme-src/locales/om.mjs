...
export const om = {
  ...
  dl_macos_warning:
    "Arclio ammallee mallattoo hin qabdu, kanaaf macOS Gatekeeper yeroo jalqabaa si akeeka. Kun eegamu — midhaan agarsiisu miti.",
  dl_macos_m1_h4: "Mala System Settings (gorsamaa):",
  dl_macos_step1: "Akaawuntii app Arclio mirga-cuqaasi fi **Open** filadhu.",
  dl_macos_step2:
  ...
  dl_macos_step4:
    'Kutaa **Security** hamma gaditti deemi. *"Arclio meeshaa guddaa hin taanee irraa waan ta\'eef itti fayyadamuun dhorkaame."* ni argita.',
  dl_macos_step5:
    "**Open Anyway** cuqaasi fi jecha darbii keetin ykn Touch ID waliin mirkaneessi.",
  dl_macos_after:
    "Tarkaanfii 5 boodaa, Arclio salphaan ni banama fi akeekkachiisni ammas hin mul'atu.",
  ...
  dl_macos_sequoia_step1:
    "`Arclio.app` DMG ramadame irraa `/Applications` tti harkisi.",
  dl_macos_sequoia_step2:
    "Arclio lama-cuqaasi. Diyaalogiin dhorkaaf ni mul'ata — **Done** cuqaasi (*Move to Trash* hin cuqasin).",
  dl_macos_sequoia_step3:
    '**System Settings → Privacy & Security** bani fi kutaa **Security** hamma gaditti deemi. *"Arclio was blocked to protect your Mac"* (ykn ergaa itti dhiyaatu) ni argita.',
  dl_macos_sequoia_step4:
    "**Open Anyway** cuqaasi, jecha darbii keetin ykn Touch ID waliin mirkaneessi, erga Arclio `/Applications` irraa deebi'ii eegali.",
  dl_macos_sonoma_h4: "macOS Sonoma 14 fi dura",
  dl_macos_sonoma_step1:
    "`Arclio.app` DMG ramadame irraa `/Applications` tti harkisi.",
  dl_macos_sonoma_step2:
    "`Arclio.app` `/Applications` keessatti mirga-cuqaasi (ykn Control-cuqaasi) fi **Open** filadhu.",
  dl_macos_sonoma_step3:
    "Diyaalogiin akeekkachiisaa amma **Open** button qaba — cuqaasii mirkaneessi. Arclio salphaan ni banama fi akeekkachiisni ammas hin mul'atu.",
  dl_macos_damaged_h4:
  ...
  faq_q6: "Arclio afaan meeqa keessatti argamu?",
  faq_a6:
  ...
  plan_r6_desc:
    "Browser windows Arclio keessa bani, akka sign in gootuu fi site cookies osoo harkaan export hin godhin fayyadamtuuf",
