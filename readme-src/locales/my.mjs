...
export const my = {
  ...
  dl_macos_warning:
    "Arclio သည် code-sign မလုပ်ရသေးသောကြောင့် macOS Gatekeeper သည် ပထမဆုံး launch လုပ်သည့်အခါ သတိပေးလိမ့်မည်။ ၎င်းသည် မျှော်မှန်းထားသောဖြစ်ရပ်ဖြစ်ပြီး ပျက်စီးမှုသင်္ကေတမဟုတ်ပါ။",
  dl_macos_m1_h4: "System Settings နည်းလမ်း (အကြံပြု):",
  dl_macos_step1: "Arclio app icon ကို right-click ပြီး **Open** ကိုရွေးပါ။",
  dl_macos_step2:
  ...
  dl_macos_step4:
    '**Security** section သို့ scroll ဆင်းပါ။ *"Arclio was blocked from use because it is not from an identified developer."* ဟုမြင်ရလိမ့်မည်။',
  dl_macos_step5:
    "**Open Anyway** ကိုနှိပ်ပြီး သင့် password သို့မဟုတ် Touch ID ဖြင့် အတည်ပြုပါ။",
  dl_macos_after:
    "အဆင့် ၅ ပြီးနောက် Arclio သည် ပုံမှန်ဖွင့်ပြီး သတိပေးချက်သည် နောက်ထပ်မပေါ်တော့ပါ။",
  ...
  dl_macos_sequoia_step1:
    "တပ်ဆင်ထားသော DMG မှ `Arclio.app` ကို `/Applications` သို့ ဆွဲထည့်ပါ။",
  dl_macos_sequoia_step2:
    "Arclio ကို double-click နှိပ်ပါ။ ပိတ်ဆို့မှု dialog ပေါ်လာသည် — **Done** ကိုနှိပ်ပါ (*Move to Trash* ကိုမနှိပ်ပါနှင့်)။",
  dl_macos_sequoia_step3:
    '**System Settings → Privacy & Security** ကိုဖွင့်ပြီး **Security** section သို့ scroll ဆင်းပါ။ *"Arclio was blocked to protect your Mac"* (သို့မဟုတ် ၎င်းနှင့်ဆင်တူသော message) မြင်ရပါမည်။',
  dl_macos_sequoia_step4:
    "**Open Anyway** ကိုနှိပ်ပြီး သင့် password သို့မဟုတ် Touch ID ဖြင့် အတည်ပြုကာ `/Applications` မှ Arclio ကို ပြန်လည်ဖွင့်ပါ။",
  dl_macos_sonoma_h4: "macOS Sonoma 14 နှင့် အစောပိုင်း",
  dl_macos_sonoma_step1:
    "တပ်ဆင်ထားသော DMG မှ `Arclio.app` ကို `/Applications` သို့ ဆွဲထည့်ပါ။",
  dl_macos_sonoma_step2:
    "`/Applications` ထဲရှိ `Arclio.app` ကို right-click (သို့မဟုတ် Control-click) နှိပ်ပြီး **Open** ကိုရွေးပါ။",
  dl_macos_sonoma_step3:
    "သတိပေးမှု dialog တွင် **Open** ခလုတ်ပေါ်လာသည် — ၎င်းကိုနှိပ်ပြီး အတည်ပြုပါ။ Arclio ပုံမှန်ဖွင့်ပြီး သတိပေးချက်သည် နောက်ထပ်မပေါ်တော့ပါ။",
  dl_macos_damaged_h4:
  ...
  faq_q6: "Arclio ကို မည်သည့်ဘာသာစကားများဖြင့် ရနိုင်သနည်း?",
  faq_a6:
  ...
  plan_r6_desc:
    "Arclio ထဲတွင် browser windows ဖွင့်ပြီး sign in လုပ်ကာ site cookies ကို manually export မလုပ်ဘဲ အသုံးပြုနိုင်ရန်",
