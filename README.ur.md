...
Arroxy [TelemetryDeck](https://telemetrydeck.com) کے ذریعے گمنام، اجتماعی ٹیلی میٹری بھیجتا ہے — صرف اتنی کہ ایک انڈی پروجیکٹ یہ دیکھ سکے کہ کوئی واقعی اسے استعمال کر رہا ہے یا نہیں (لانچز، OS، ایپ ورژن، کریشز)۔ کوئی URLs نہیں، کوئی ویڈیو ٹائٹلز نہیں، کوئی فائل پاتھز نہیں، کوئی اکاؤنٹ کی معلومات نہیں۔ فی انسٹال ID کو بھیجنے سے پہلے ہیش کیا جاتا ہے اور TelemetryDeck کبھی IPs محفوظ نہیں کرتا — EU میں ہوسٹڈ اور بنیادی ڈیزائن کے لحاظ سے GDPR دوستانہ ہے۔ آپ Settings میں اسے بند کر سکتے ہیں۔
