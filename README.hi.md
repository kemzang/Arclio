...
Arroxy [TelemetryDeck](https://telemetrydeck.com) के ज़रिए अनाम, एग्रीगेट टेलीमेट्री भेजता है — बस इतना कि एक इंडी प्रोजेक्ट देख सके कि कोई इसे इस्तेमाल कर रहा है या नहीं (लॉन्च, OS, ऐप वर्शन, क्रैश)। कोई URLs नहीं, कोई वीडियो टाइटल नहीं, कोई फ़ाइल पाथ नहीं, कोई अकाउंट जानकारी नहीं। प्रति-इंस्टॉल ID भेजने से पहले हैश की जाती है और TelemetryDeck कभी IPs स्टोर नहीं करता — EU-होस्टेड और डिज़ाइन से GDPR-फ़्रेंडली। Settings में ऑप्ट-आउट कर सकते हैं।
