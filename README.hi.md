...
| ------------------- | ----------------- |
| 🪟 Windows          | [NSIS इंस्टॉलर](https://github.com/antonio-orionus/Arroxy/releases/latest/download/Arroxy-win-x64-Setup.exe) · [पोर्टेबल `.exe`](https://github.com/antonio-orionus/Arroxy/releases/latest/download/Arroxy-win-x64-Portable.exe) |
