...
| ሥርዓተ ክወና | ቅርጸት |
| ------------------- | ----------------- |
| 🪟 Windows          | [NSIS ጫኝ](https://github.com/antonio-orionus/Arroxy/releases/latest/download/Arroxy-win-x64-Setup.exe) · [ተጓዥ `.exe`](https://github.com/antonio-orionus/Arroxy/releases/latest/download/Arroxy-win-x64-Portable.exe) |
