...
يرسل Arroxy بيانات تشخيصية مجهولة ومجمَّعة عبر [TelemetryDeck](https://telemetrydeck.com) — بما يكفي فقط لمشروع مستقل لمعرفة ما إذا كان أحد يستخدمه فعلاً (عمليات التشغيل، OS، إصدار التطبيق، الأعطال). لا URLs، لا عناوين فيديو، لا مسارات ملفات، لا معلومات حساب. يُجزَّأ معرِّف كل تثبيت قبل الإرسال ولا يخزِّن TelemetryDeck عناوين IPs — مستضاف في EU وصديق لـ GDPR بحكم التصميم. يمكنك إيقافه من الإعدادات.
