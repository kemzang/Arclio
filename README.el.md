...
- **Προσεκτική λειτουργία** — παραμετροποιήσιμα preset ρυθμού (*Ανενεργό · Ισορροπημένο · Προσεκτικό · Προσαρμοσμένο*) που προσθέτουν καθυστερήσεις μεταξύ αιτημάτων και περιορίζουν τα fragment threads, μειώνοντας την πιθανότητα bot-block σε μεγάλες playlist
...
Ναι — και τα δύο. Επικολλήστε URL playlist ή channel (π.χ. `youtube.com/@handle`, `/channel/UC…`, `/c/Name`, `/user/Old`); το Arroxy απαριθμεί έως 500 καταχωρήσεις, στη συνέχεια βάλτε στην ουρά ολόκληρη τη λίστα ή διαλέξτε συγκεκριμένα βίντεο. Φίλτρα εύρους ημερομηνιών και πλήθους έρχονται σύντομα.
...
| ---------------- | ---------------- |
| **Φίλτρα playlist & καναλιών** | Φίλτρα εύρους ημερομηνιών και πλήθους κατά την απαρίθμηση playlist ή καναλιού (σήμερα το όριο είναι σταθερές 500 καταχωρήσεις) |
