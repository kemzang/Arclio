...
- **Έλεγχοι ήχου** — εξαγωγή μόνο ήχου σε MP3, M4A/AAC, Opus ή WAV· ορισμός καθολικής επιλογής **Προτίμηση surround / Dolby**· και διατήρηση εγγενών Dolby AC-3/EC-3, πολυκάναλων, DRC και άλλων προηγμένων κομματιών ήχου ως επιλέξιμων στις διαδραστικές λήψεις όταν είναι διαθέσιμα
...
| **Προτιμήσεις ηχητικών κομματιών YouTube** | Επιλογή προτιμώμενων κομματιών ομιλούμενης γλώσσας όταν το YouTube παρέχει πολλαπλά ηχητικά κομμάτια |
