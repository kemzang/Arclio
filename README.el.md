...
Το Arroxy στέλνει ανώνυμη, συγκεντρωτική τηλεμετρία μέσω [TelemetryDeck](https://telemetrydeck.com) — αρκετά για ένα indie project να δει αν κάποιος το χρησιμοποιεί πραγματικά (εκκινήσεις, OS, έκδοση εφαρμογής, σφάλματα). Χωρίς URLs, χωρίς τίτλους βίντεο, χωρίς διαδρομές αρχείων, χωρίς πληροφορίες λογαριασμού. Το αναγνωριστικό ανά εγκατάσταση γίνεται hashed πριν αποσταλεί και το TelemetryDeck δεν αποθηκεύει ποτέ IPs — φιλοξενείται στην EU και φιλικό προς το GDPR εκ σχεδιασμού. Μπορείτε να το απενεργοποιήσετε στις Ρυθμίσεις.
