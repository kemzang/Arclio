...
| 平台 | 格式 |
| ------------------- | ----------------- |
| 🪟 Windows          | [NSIS 安装版](https://github.com/antonio-orionus/Arroxy/releases/latest/download/Arroxy-win-x64-Setup.exe) · [便携版 `.exe`](https://github.com/antonio-orionus/Arroxy/releases/latest/download/Arroxy-win-x64-Portable.exe) |
