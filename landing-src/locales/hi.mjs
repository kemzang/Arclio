...
export const hi = {
  ...
  p3_p: "TelemetryDeck के ज़रिए गुमनाम टेलीमेट्री — आपकी प्रति-इंस्टॉल ID ऐप छोड़ने से पहले हैश की जाती है, कोई फ़िंगरप्रिंटिंग नहीं, कोई व्यक्तिगत डेटा नहीं। आपके डाउनलोड, इतिहास और फ़ाइलें कभी आपकी मशीन नहीं छोड़तीं।",
