...
export const hi = {
  title: "Arroxy — मुफ़्त 4K YouTube + 2000 साइट डाउनलोडर, बिना लॉगिन के",
  description:
    "Windows, macOS और Linux के लिए मुफ़्त, MIT-लाइसेंस्ड डेस्कटॉप YouTube और 2000+ समर्थित साइटों का डाउनलोडर। 4K HDR तक 60 fps में वीडियो डाउनलोड करें। कोई विज्ञापन नहीं, कोई ब्लोट नहीं, कोई अपसेल नहीं।",
  og_title: "Arroxy — मुफ़्त 4K YouTube + 2000 साइट डाउनलोडर, बिना लॉगिन के",
  og_description:
    "YouTube और 2000+ साइटों के लिए मुफ़्त 4K डाउनलोडर। कोई विज्ञापन नहीं, कोई ब्लोट नहीं, कोई अपसेल नहीं। MIT-लाइसेंस्ड। Windows · macOS · Linux।",
  ...
  hero_h1_a: "मुफ़्त 4K YouTube (+ 2000 साइट) डाउनलोडर।",
  hero_h1_b: "कोई विज्ञापन नहीं, कोई ब्लोट नहीं, कोई अपसेल नहीं।",
  hero_tagline:
    "Arroxy Windows, macOS और Linux के लिए एक मुफ़्त, MIT-लाइसेंस्ड डेस्कटॉप YouTube और 2000+ समर्थित साइटों का डाउनलोडर है। 4K HDR तक 60 fps में वीडियो डाउनलोड करता है। कोई विज्ञापन नहीं, कोई ब्लोट नहीं, कोई अपसेल नहीं — बस URL पेस्ट करें और शुरू करें।",
  hero_trust: "GitHub पर हर लाइन ऑडिट करें।",
  pill_no_tracking: "कोई ट्रैकिंग नहीं",
  pill_no_account: "कोई विज्ञापन नहीं",
  ...
  f1_h: "4K UHD तक",
  f1_p: "2160p, 1440p, 1080p, 720p — YouTube और अन्य समर्थित साइटें जो भी resolution देती हैं, साथ ही सिर्फ ऑडियो के लिए MP3, M4A/AAC, Opus और WAV conversion।",
  ...
  f4_h: "स्वचालित अपडेट",
  f4_p: "Arroxy yt-dlp को ताज़ा रखता है और ffmpeg ऐप के अंदर देता है — YouTube और अन्य साइटों के बदलते रहने के साथ हर हफ़्ते फ़िक्स जारी करता है।",
  f5_h: "21 भाषाएँ",
  ...
  f9_p: "कहीं भी कोई भी समर्थित लिंक कॉपी करें और वापस स्विच करने पर Arroxy तुरंत पहचान लेता है — एक पुष्टि प्रॉम्प्ट नियंत्रण बनाए रखता है। Advanced settings में सक्षम या अक्षम करें।",
  f10_h: "URL को अपने आप साफ़ करें",
  f10_p: "ट्रैकिंग पैरामीटर (si, pp, feature, utm_*, fbclid, gclid और अन्य) पेस्ट किए गए लिंक से अपने आप हट जाते हैं, और youtube.com/redirect रैपर खुल जाते हैं — URL फ़ील्ड में हमेशा canonical लिंक दिखता है।",
  ...
  og_image_alt: "Arroxy ऐप आइकन — YouTube और 2000+ अन्य साइटों से 4K में डाउनलोड करने के लिए डेस्कटॉप ऐप।",

  privacy_eyebrow: "गोपनीयता",
  privacy_h2_html: "Arroxy जो <em>नहीं</em> करता है।",
  privacy_sub:
    "100% लोकल प्रोसेसिंग। कोई विज्ञापन नहीं, कोई अपसेल नहीं, कोई थर्ड-पार्टी सर्वर नहीं — फ़ाइलें yt-dlp से सीधे आपकी डिस्क पर जाती हैं।",
  p1_h: "कोई लॉगिन आवश्यक नहीं",
  p1_p: "डिफ़ॉल्ट मोड बिना किसी Google खाते या लॉगिन के काम करता है। आयु-प्रतिबंधित या केवल-सदस्य सामग्री के लिए Advanced settings में वैकल्पिक कुकी सपोर्ट उपलब्ध है — डिफ़ॉल्ट रूप से बंद।",
  p2_h: "केवल लोकल फ़ाइलें",
  p2_p: "फ़ाइलें yt-dlp से सीधे आपके चुने हुए फ़ोल्डर में जाती हैं। कुछ भी रिमोट सर्वर से नहीं गुज़रता।",
  ...
  p4_h: "कोई विज्ञापन नहीं, कोई अपसेल नहीं",
  p4_p: "MIT लाइसेंस। कोई प्रीमियम टियर नहीं, कोई फ़ीचर गेटिंग नहीं, कोई बैनर विज्ञापन नहीं, कोई डार्क पैटर्न नहीं। पूरी pipeline yt-dlp + ffmpeg के ज़रिए लोकल पर चलती है।",
  ...
  faq_a1:
    "YouTube और अन्य समर्थित साइटें जो भी देती हैं — 4K UHD (2160p), 1440p QHD, 1080p Full HD, 720p, 480p, 360p और सिर्फ ऑडियो। High frame-rate streams (60 fps, 120 fps) और HDR content ज्यों का त्यों रखा जाता है। Arroxy हर available format दिखाता है, जिसमें सिर्फ ऑडियो downloads के लिए MP3, M4A/AAC, Opus और WAV conversion भी शामिल है।",
  ...
  faq_a5:
    "हाँ — और Arroxy में दो लेयर रिज़िलियेंस है। पहला, yt-dlp सबसे एक्टिवली मेनटेन्ड ओपन-सोर्स टूल्स में से एक है — किसी भी समर्थित साइट के बदलाव के घंटों के भीतर अपडेट होता है, जिसमें YouTube भी शामिल है। दूसरा, Arroxy कुकीज़ या आपके Google अकाउंट पर बिल्कुल निर्भर नहीं है, इसलिए कोई सेशन एक्सपायर नहीं होता और कोई क्रेडेंशियल रोटेट नहीं करना। यह कॉम्बिनेशन इसे ब्राउज़र की कुकीज़ एक्सपोर्ट करने पर निर्भर टूल्स से कहीं ज़्यादा स्थिर बनाता है।",
  ...
  faq_a7:
    "डिफ़ॉल्ट रूप से नहीं — Arroxy बिना किसी अकाउंट, लॉगिन या कुकी एक्सपोर्ट के काम करता है। Advanced settings में (फ़ाइल या browser-import) वैकल्पिक कुकी सपोर्ट उपलब्ध है — आयु-प्रतिबंधित या केवल-सदस्य वीडियो जैसी authentication की ज़रूरत वाली सामग्री के लिए। डिफ़ॉल्ट रूप से बंद। अगर आप इसे चालू करते हैं, तो yt-dlp की डॉक्स चेताती है कि कुकी-आधारित automation Google अकाउंट को फ़्लैग कर सकता है, इसलिए throwaway अकाउंट ज़्यादा सुरक्षित विकल्प है।",
  ...
  f13_h: "YouTube + 2000 साइट",
  f13_p: "YouTube के अलावा, Arroxy 2000+ साइटों से भी डाउनलोड करता है जिन्हें yt-dlp सपोर्ट करता है — Vimeo, Twitch, Twitter/X, TikTok, SoundCloud, Bandcamp, Bilibili, BBC iPlayer, archive.org और भी बहुत कुछ। सिर्फ ऑडियो और सबटाइटल हर जगह काम करते हैं, न सिर्फ YouTube पर।",

  mid_cta_h2: "पसंद आया?",
  mid_cta_sub: "मुफ़्त डाउनलोड करें। कोई अकाउंट नहीं, कोई विज्ञापन नहीं, कोई शर्त नहीं।",
  end_cta_h2: "हमेशा के लिए मुफ़्त। ओपन सोर्स। कोई छुपी बात नहीं।",
  end_cta_sub: "उन हज़ारों लोगों से जुड़ें जो Arroxy से डाउनलोड कर रहे हैं। एक क्लिक, फिर बस काम होता है।",
};
