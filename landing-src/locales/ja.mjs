...
export const ja = {
  ...
  f1_h: "最大 4K UHD",
  f1_p: "2160p、1440p、1080p、720p — YouTube が提供するあらゆる解像度に対応し、音声のみのダウンロードは MP3、M4A/AAC、Opus、WAV へ変換できます。",
  ...
  p3_h: "ユーザー ID なし",
  p3_p: "TelemetryDeck による匿名テレメトリー — インストールごとの ID はアプリを離れる前にハッシュ化され、フィンガープリンティングなし、個人データなし。ダウンロード、履歴、ファイルはすべてあなたのデバイス内に留まります。",
  p4_h: "サードパーティサーバーなし",
  ...
  faq_a1:
    "YouTube が提供するものなら何でも対応しています。4K UHD（2160p）、1440p QHD、1080p Full HD、720p、480p、360p、そして音声のみ。高フレームレートのストリーム（60 fps、120 fps）や HDR コンテンツもそのまま保持されます。Arroxy は利用可能な形式をすべて表示し、音声のみのダウンロードでは MP3、M4A/AAC、Opus、WAV への変換も選べます。",
  faq_q2: "本当に無料ですか？",
