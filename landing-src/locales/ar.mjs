...
export const ar = {
  ...
  p3_p: "قياسات عن بُعد مجهولة الهوية عبر TelemetryDeck — يُجزَّأ معرِّف التثبيت الخاص بك قبل مغادرته التطبيق، بلا بصمة رقمية، بلا بيانات شخصية. تحميلاتك وسجلّك وملفاتك لا تغادر جهازك أبداً.",
