...
export const sr = {
  ...
  f1_h: "До 4K UHD",
  f1_p: "2160p, 1440p, 1080p, 720p — svaka rezolucija koju YouTube nudi, plus konverzija samo zvuka u MP3, M4A/AAC, Opus i WAV.",
  ...
  p3_p: "Анонимна телеметрија преко TelemetryDeck-а — ваш ID по инсталацији се хешује пре него што напусти апликацију, без отиска уређаја, без личних података. Ваша преузимања, историја и датотеке никада не напуштају ваш уређај.",
  ...
  faq_a1:
    "Sve što YouTube nudi — 4K UHD (2160p), 1440p QHD, 1080p Full HD, 720p, 480p, 360p i samo audio. Strimovi sa visokim brojem frejmova (60 fps, 120 fps) i HDR sadržaj ostaju netaknuti. Arroxy prikazuje svaki dostupni format, uključujući konverziju u MP3, M4A/AAC, Opus i WAV za preuzimanja samo zvuka.",
