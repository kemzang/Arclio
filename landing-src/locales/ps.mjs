...
export const ps = {
  ...
  f4_p: "Arroxy yt-dlp تازه ساتي او ffmpeg د اپ دننه راځي — د YouTube هر بدلون سره کار کوي.",
  f5_h: "۲۱ ژبې",
  ...
  p3_h: "ناپیژندلې ټیلیمیټري",
  p3_p: "د OpenPanel له لارې ناپیژندلې ټیلیمیټري — د هر نصب تصادفي ID د پیلونو، نسخو، OS او کریشونو شمېرلو کې مرسته کوي؛ URLs، سرلیکونه، د فایل لارې، د اکاونټ معلومات، fingerprinting یا شخصي معلومات نشته. ستاسو ډاونلوډونه، تاریخچه او فایلونه هیڅکله ستاسو ماشین نه پرېږدي.",
