...
export const ru = {
  ...
  p3_p: "Анонимная телеметрия через TelemetryDeck — ваш ID установки хешируется перед отправкой из приложения, никакого фингерпринтинга, никаких личных данных. Ваши загрузки, история и файлы никогда не покидают ваше устройство.",
