...
export const uk = {
  ...
  f1_h: "До 4K UHD",
  f1_p: "2160p, 1440p, 1080p, 720p — будь-яка роздільна здатність, яку пропонує YouTube, плюс конвертація лише аудіо в MP3, M4A/AAC, Opus і WAV.",
  ...
  f4_h: "Автооновлення",
  f4_p: "Arroxy підтримує yt-dlp актуальним, а ffmpeg постачається всередині застосунку — працює після будь-яких змін YouTube.",
  f5_h: "21 мова",
  ...
  faq_a1:
    "Усе, що пропонує YouTube — 4K UHD (2160p), 1440p QHD, 1080p Full HD, 720p, 480p, 360p і лише аудіо. Потоки з високою частотою кадрів (60 fps, 120 fps) і HDR-контент зберігаються як є. Arroxy показує кожен доступний формат, включно з конвертацією в MP3, M4A/AAC, Opus і WAV для аудіо-завантажень.",
