...
export const uk = {
  ...
  p3_p: "Анонімна телеметрія через TelemetryDeck — ваш ID установки хешується перед відправкою з застосунку, без знімання відбитків, без особистих даних. Ваші завантаження, історія та файли ніколи не залишають вашу машину.",
