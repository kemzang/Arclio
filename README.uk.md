...
| Платформа | Формат |
| ------------------- | ----------------- |
| 🪟 Windows          | [Інсталятор NSIS](https://github.com/antonio-orionus/Arroxy/releases/latest/download/Arroxy-win-x64-Setup.exe) · [Портативний `.exe`](https://github.com/antonio-orionus/Arroxy/releases/latest/download/Arroxy-win-x64-Portable.exe) |
