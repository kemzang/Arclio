...
- **Осторожный режим** — настраиваемые пресеты темпа (*Выкл · Сбалансировано · Осторожно · Свой*) добавляют паузы между запросами и ограничивают потоки фрагментов, снижая шанс bot-blocks на больших плейлистах
...
Да — и то, и другое. Вставьте URL плейлиста или канала (например, `youtube.com/@handle`, `/channel/UC…`, `/c/Name`, `/user/Old`); Arroxy перечислит до 500 записей, после чего можно поставить в очередь весь список или выбрать конкретные видео. Фильтры по диапазону дат и количеству появятся в ближайшее время.
...
| Функция    | Описание    |
| ---------------- | ---------------- |
| **Фильтры плейлистов и каналов** | Фильтры по диапазону дат и количеству при перечислении плейлиста или канала (сейчас лимит — фиксированные 500 записей) |
