...
| প্ল্যাটফর্ম | ফরম্যাট |
| ------------------- | ----------------- |
| 🪟 Windows          | [NSIS ইনস্টলার](https://github.com/antonio-orionus/Arroxy/releases/latest/download/Arroxy-win-x64-Setup.exe) · [পোর্টেবল `.exe`](https://github.com/antonio-orionus/Arroxy/releases/latest/download/Arroxy-win-x64-Portable.exe) |
