...
Arroxy [TelemetryDeck](https://telemetrydeck.com)-এর মাধ্যমে বেনামী, সমষ্টিগত টেলিমেট্রি পাঠায় — শুধু একটি ইন্ডি প্রজেক্টের জন্য যথেষ্ট যাতে দেখা যায় কেউ আদৌ ব্যবহার করছে কিনা (চালু, OS, অ্যাপ ভার্সন, ক্র্যাশ)। কোনো URLs নেই, কোনো ভিডিওর শিরোনাম নেই, কোনো ফাইল পাথ নেই, কোনো অ্যাকাউন্টের তথ্য নেই। প্রতি-ইনস্টল ID পাঠানোর আগে হ্যাশ করা হয় এবং TelemetryDeck কখনো IPs সংরক্ষণ করে না — EU-হোস্টেড এবং ডিজাইন অনুযায়ী GDPR-বান্ধব। সেটিংসে অপ্ট-আউট করতে পারবেন।
