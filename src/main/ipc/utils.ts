...
export function buildCommonPaths(): CommonPaths {
	...
	return {downloads: safeAppPath('downloads'), videos: safeAppPath('videos'), music: safeAppPath('music'), ...(isFlatpak ? {} : {desktop: safeAppPath('desktop'), documents: safeAppPath('documents'), pictures: safeAppPath('pictures'), home: safeAppPath('home')})}
}
