...
export const youtubeSite: Site = {
  id: 'youtube',
  needsPotToken: true,
  supportsSponsorBlock: true,
  needsAutoCaptionDedupe: true,
  autoCaptionRequiresOrigSuffix: true,
  hintForPlaylistId: youtubeHintForId,
  isNestedContainer: youtubeIsNested
};
