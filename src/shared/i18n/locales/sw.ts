const sw = {
	common: {back: 'Rudi', cancel: 'Ghairi', continue: 'Endelea', retry: 'Jaribu tena', startOver: 'Anza upya'},
	app: {feedback: 'Maoni', logs: 'Kumbukumbu', feedbackNudge: 'Unafurahia Arroxy? Ningependa kusikia kutoka kwako! 💬', debugCopied: 'Imenakiliwa!', debugCopyTitle: 'Nakili maelezo ya utatuzi (matoleo ya Electron, OS, Chrome)', zoomIn: 'Kuza', zoomOut: 'Punguza'},
	about: {button: 'Kuhusu', openTitle: 'Kuhusu Arroxy', tagline: 'Kipakuzi cha video na sauti cha haraka na rahisi kwa kompyuta.', websiteLink: 'Tovuti', githubLink: 'GitHub', licenseLine: 'Leseni ya MIT · na Antonio Orionus', thirdPartyNotices: 'Tazama notisi za wengine'},
	titleBar: {close: 'Funga', minimize: 'Punguza', maximize: 'Panua', restore: 'Rejesha'},
	splash: {greeting: 'Hujambo, karibu tena!', warmup: 'Arroxy inajipanga…', downloading: 'Inapakua {{binary}}…', warmupFailedNoDiag: 'Usanidi umeshindwa. Fungua kumbukumbu ya usanidi kwa maelezo zaidi.'},
	repair: {
	...
	theme: {light: 'Hali ya mwanga', dark: 'Hali ya giza', system: 'Chaguo-msingi la mfumo'},
	language: {label: 'Lugha'},
	wizard: {
		steps: {url: 'URL', playlistItems: 'Playlist', playlistPresets: 'Ubora', formats: 'Umbizo', subtitles: 'Manukuu', sponsorblock: 'SponsorBlock', output: 'Matokeo', folder: 'Hifadhi', confirm: 'Thibitisha'},
		playlist: {
		...
		url: {
			...
			features: {
				...
				youtube: {heading: 'YouTube', video: 'Video', channel: 'Vituo', playlist: 'Playlists', short: 'Shorts', music: 'Muziki', podcast: 'Podcasts'},
				anySite: {heading: 'Tovuti 2000+', video: 'Video', videoPlaylist: 'Playlists za video', musicPlaylist: 'Playlists za muziki'},
				always: {heading: 'Daima inapatikana', audioOnly: 'Sauti peke yake', subtitles: 'Manukuu'}
			},
			...
			proxy: {label: 'Proxy URL', description: 'Peleka trafiki kupitia proksi — muhimu kwa maudhui yenye vizuizi vya kijiografia.', placeholder: 'http://host:port', clear: 'Futa'},
			playlistProbeLimit: {
			...
			singleFilenameId: {toggle: 'Ongeza ID ya video kwenye majina ya faili moja moja', toggleDescription: 'Huweka upakuaji wa mara moja kuwa wa kipekee wakati vichwa vinabadilika au kugongana.'},
			networkPacing: {
				...
				presets: {off: 'Zima', balanced: 'Uwiano', careful: 'Uangalifu', custom: 'Maalum'},
				tooltips: {
				...
				fields: {sleepRequests: 'Pumzika kati ya ukaguzi wa metadata', sleepInterval: 'Pumzika kabla ya media kuanza: kiwango cha chini', maxSleepInterval: 'Pumzika kabla ya media kuanza: kiwango cha juu', sleepSubtitles: 'Pumzika kabla ya faili za manukuu', concurrentFragments: 'Miunganisho ya kupakua'},
				units: {seconds: 'sek', threads: 'miunganisho'}
			},
			closeToTray: {toggle: 'Ficha kwenye tray ukifunga', toggleDescription: 'Endelea kupakua nyuma ya pazia baada ya kufunga dirisha.'},
			analytics: {toggle: 'Tuma takwimu za matumizi zisizo na jina', toggleDescription: 'Huhesabu tu uzinduzi wa programu. Hakuna URL, majina ya faili, au data za kibinafsi.'},
			limitRate: {
		...
		subtitles: {
			...
			saveMode: {heading: 'Hifadhi kama', sidecar: 'Karibu na video', embed: 'Ingiza kwenye video', subfolder: 'subtitles/ saraka ndogo'},
			format: {heading: 'Umbizo'},
		...
		sponsorblock: {
			...
			mode: {off: 'Zima', mark: 'Weka alama kama sura', remove: 'Ondoa sehemu'},
			modeHint: {off: 'Hakuna SponsorBlock — video inacheza kama ilivyopakiwa.', mark: 'Inaweka alama sehemu za mdhamini kama sura (bila uharibifu).', remove: 'Hukata sehemu za mdhamini kutoka kwenye video kwa kutumia FFmpeg.'},
			categoriesHeading: 'Kategoria',
			cat: {sponsor: 'Mdhamini', intro: 'Utangulizi', outro: 'Mwisho', selfpromo: 'Kujitangaza', music_offtopic: 'Music off-topic', preview: 'Muhtasari', filler: 'Kijazio'}
		},
		formats: {
			...
			cookiesError: {
				...
				needsCookies: {heading: 'Tovuti hii inahitaji kuingia', body: 'yt-dlp haikuweza kufikia video hii bila uthibitisho. Sanidi vidakuzi katika mipangilio ya hali ya juu — ielekeza kwenye kivinjari unachoingia tayari, au ingiza faili ya cookies.txt.'},
				dpapi: {
		...
		folder: {
			...
			home: 'Nyumbani',
			custom: 'Maalum…',
			subfolder: {toggle: 'Hifadhi ndani ya saraka ndogo', placeholder: 'mfano lo-fi rips', invalid: 'Jina la saraka lina herufi batili'}
		},
		output: {
			embedChapters: {label: 'Ingiza sura', description: 'Alama za sura zinazoweza kuabiriwa katika kichezaji chochote cha kisasa.'},
			embedMetadata: {label: 'Ingiza metadata', description: 'Kichwa, msanii, maelezo, na tarehe ya kupakia vimeandikwa kwenye faili.'},
			embedThumbnail: {label: 'Ingiza picha ndogo', description: 'Sanaa ya jalada ndani ya faili. Video ya WebM itabadilishwa kuwa MKV; hupitishwa wakati manukuu yanaingizwa.'},
			writeDescription: {label: 'Hifadhi maelezo', description: 'Inahifadhi maelezo ya video kama faili ya maandishi ya .description karibu na kipakuliwa.'},
			writeThumbnail: {label: 'Hifadhi picha ndogo', description: 'Inahifadhi picha ndogo kama faili ya picha ya .jpg karibu na kipakuliwa.'},
			writeM3u: {label: 'Tengeneza faili ya playlist .m3u', description: 'Hifadhi playlist ya .m3u pamoja na video ili zifunguke kwa mpangilio kwenye kicheza media.'}
		},
		confirm: {
	...
	videoCard: {titlePlaceholder: 'Inapakia…'},
	queue: {
	...
	presets: {
		'best-quality': {label: 'Ubora bora', desc: 'Azimio la juu zaidi + sauti bora'},
		balanced: {label: 'Uwiano', desc: '720p kiwango cha juu + sauti nzuri'},
		'audio-only': {label: 'Sauti peke yake', desc: 'Hakuna video, sauti bora'},
		'small-file': {label: 'Faili ndogo', desc: 'Azimio la chini + sauti ya chini'},
		'subtitle-only': {label: 'Manukuu peke yake', desc: 'Hakuna video, hakuna sauti, manukuu peke yake'}
	},
	playlistPresets: {
		type: {video: 'Video', audio: 'Audio'},
		videoFormat: {best: 'Best codec', mp4: 'MP4 (H.264)'},
		videoFormatDesc: {best: 'Kodeki bora inayopatikana kwa kila kipengee', mp4: 'H.264 + AAC inapendelewa, kontena MP4 · juhudi bora'},
		tier: {best: 'Best quality', '2160': 'Hadi 4K', '1440': 'Hadi 1440p', '1080': 'Hadi 1080p', '720': 'Hadi 720p', '480': 'Hadi 480p', '360': 'Hadi 360p'},
		tierDesc: {
		...
		audioFormatDesc: {best: 'Sauti bora asilia, bila kusimba upya', mp3: 'Geuza kuwa MP3', m4a: 'Geuza kuwa M4A (AAC)', opus: 'Geuza kuwa Opus'},
		audioFormatBitrate: 'Audio ({{format}} {{kbps}}K)',
		mp4Cap: 'H.264 zaidi ya 1080p haipatikani YouTube — hupunguzwa kiotomatiki hadi 1080p'
	},
	formatLabel: {audioFallback: 'Sauti', audioOnlyDot: 'Sauti peke yake · {{audio}}', videoDot: '{{resolution}} · {{audio}}'},
	tray: {tooltip: 'Arroxy', menu: {statusIdle: 'Tulivu', statusActive_one: '1 inapakua · {{percent}}%', statusActive_other: '{{count}} zinapakua · {{percent}}%', open: 'Fungua Arroxy', quit: 'Funga Arroxy'}},
	dialogs: {
		quitWithActiveDownloads: {message_one: 'Upakuaji {{count}} unaendelea', message_other: 'Vipakuzi {{count}} vinavyoendelea', detail: 'Kufunga kutafuta vipakuzi vyote vinavyofanya kazi.', confirm: 'Ghairi Vipakuzi na Toka', keep: 'Endelea Kupakua', pause: 'Sitisha vipakuliwa na uondoke'},
		closeToTray: {message: 'Ficha Arroxy kwenye tray ya mfumo ukifunga?', detail: 'Arroxy inaendelea kufanya kazi na kukamilisha vipakuzi vinavyofanya kazi. Badilisha hii baadaye katika mipangilio ya Hali ya juu.', hide: 'Ficha kwenye tray', quit: 'Toka', remember: 'Usiulize tena'},
		rendererCrashed: {message: 'Arroxy imekutana na tatizo', detail: 'Mchakato wa uonyeshaji umeanguka ({{reason}}). Pakia upya ujaribu tena.', reload: 'Pakia upya', quit: 'Toka'}
	},
	share: {
