const ar = {
	common: {back: 'رجوع', cancel: 'إلغاء', continue: 'متابعة', retry: 'إعادة المحاولة', startOver: 'البدء من جديد'},
	app: {feedback: 'ملاحظات', logs: 'السجلات', feedbackNudge: 'هل تستمتع بـ Arroxy؟ يسعدني سماع رأيك! 💬', debugCopied: 'تم النسخ!', debugCopyTitle: 'نسخ معلومات التصحيح (إصدارات Electron والنظام وChrome)', zoomIn: 'تكبير', zoomOut: 'تصغير'},
	about: {button: 'حول', openTitle: 'حول Arroxy', tagline: 'محمّل فيديو وصوت سريع وسهل لسطح المكتب.', websiteLink: 'موقع الويب', githubLink: 'GitHub', licenseLine: 'ترخيص MIT · بواسطة Antonio Orionus', thirdPartyNotices: 'عرض إشعارات الطرف الثالث'},
	titleBar: {close: 'إغلاق', minimize: 'تصغير', maximize: 'تكبير', restore: 'استعادة'},
	splash: {greeting: 'مرحباً، أهلاً بعودتك!', warmup: 'Arroxy يستعد…', downloading: 'جارٍ تنزيل {{binary}}…', warmupFailedNoDiag: 'فشل الإعداد. افتح سجل الإعداد للاطلاع على التفاصيل.'},
	repair: {
		...
		actions: {chooseExecutable: 'اختر الملف القابل للتنفيذ', installWithHomebrew: 'التثبيت عبر Homebrew', installWithWinget: 'التثبيت عبر WinGet', resetToDefault: 'إعادة إلى الافتراضي', retrySetup: 'إعادة محاولة الإعداد', cancel: 'إلغاء', openDependencyFolder: 'فتح مجلد التبعيات', viewSetupLog: 'عرض سجل الإعداد'}
	},
	theme: {light: 'الوضع الفاتح', dark: 'الوضع الداكن', system: 'إعداد النظام الافتراضي'},
	language: {label: 'اللغة'},
	wizard: {
		steps: {url: 'URL', playlistItems: 'Playlist', playlistPresets: 'الجودة', formats: 'الصيغة', subtitles: 'الترجمات', sponsorblock: 'SponsorBlock', output: 'الإخراج', folder: 'حفظ', confirm: 'تأكيد'},
		playlist: {
		...
		url: {
			...
			features: {
				...
				youtube: {heading: 'YouTube', video: 'مقاطع فيديو', channel: 'القنوات', playlist: 'قوائم التشغيل', short: 'Shorts', music: 'الموسيقى', podcast: 'البودكاست'},
				anySite: {heading: '2000+ موقع', video: 'مقاطع فيديو', videoPlaylist: 'قوائم تشغيل الفيديو', musicPlaylist: 'قوائم تشغيل الموسيقى'},
				always: {heading: 'دائماً متاح', audioOnly: 'الصوت فقط', subtitles: 'الترجمات'}
			},
			...
			proxy: {label: 'Proxy URL', description: 'توجيه حركة البيانات عبر وكيل — مفيد للمحتوى المقيّد جغرافياً.', placeholder: 'http://host:port', clear: 'مسح'},
			playlistProbeLimit: {
			...
			singleFilenameId: {toggle: 'إضافة معرّف الفيديو إلى أسماء الملفات الفردية', toggleDescription: 'يبقي التنزيلات الفردية فريدة عندما تتغير العناوين أو تتكرر.'},
			networkPacing: {
				...
				presets: {off: 'إيقاف', balanced: 'متوازن', careful: 'حذر', custom: 'مخصص'},
				tooltips: {
				...
				fields: {sleepRequests: 'انتظار بين فحوصات البيانات الوصفية', sleepInterval: 'توقف قبل بدء الوسائط: الحد الأدنى', maxSleepInterval: 'توقف قبل بدء الوسائط: الحد الأقصى', concurrentFragments: 'اتصالات التنزيل', sleepSubtitles: 'انتظار قبل ملفات الترجمة'},
				presetLabel: 'ما مدى حذر Arroxy؟',
				units: {seconds: 'ث', threads: 'مسارات'}
			},
			closeToTray: {toggle: 'الإخفاء في علبة النظام عند الإغلاق', toggleDescription: 'تستمر التنزيلات في الخلفية بعد إغلاق النافذة.'},
			analytics: {toggle: 'إرسال إحصائيات الاستخدام المجهولة', toggleDescription: 'يحسب فقط مرات تشغيل التطبيق. بدون عناوين URL أو أسماء ملفات أو بيانات شخصية.'},
			limitRate: {
		...
		subtitles: {
			...
			saveMode: {heading: 'حفظ بصيغة', sidecar: 'بجانب الفيديو', embed: 'تضمين في الفيديو', subfolder: 'مجلد فرعي subtitles/'},
			format: {heading: 'الصيغة'},
		...
		sponsorblock: {
			...
			mode: {off: 'إيقاف', mark: 'تحديد كفصول', remove: 'إزالة المقاطع'},
			modeHint: {off: 'لا يوجد SponsorBlock — يُشغَّل الفيديو كما رُفع.', mark: 'يُحدد مقاطع الرعاة كفصول (غير تدميري).', remove: 'يحذف مقاطع الرعاة من الفيديو باستخدام FFmpeg.'},
			categoriesHeading: 'الفئات',
			cat: {sponsor: 'رعاية', intro: 'مقدمة', outro: 'خاتمة', selfpromo: 'ترويج ذاتي', music_offtopic: 'موسيقى خارج الموضوع', preview: 'معاينة', filler: 'حشو'}
		},
		formats: {
			...
			cookiesError: {
				...
				needsCookies: {heading: 'هذا الموقع يتطلب تسجيل الدخول', body: 'تعذّر على yt-dlp الوصول إلى هذا الفيديو بدون مصادقة. أعدّ الكوكيز في الإعدادات المتقدمة — وجّههم نحو متصفح سجّلت الدخول إليه مسبقاً، أو استورد ملف cookies.txt.'},
				dpapi: {
		...
		folder: {
			...
			home: 'الرئيسية',
			custom: 'مخصص…',
			subfolder: {toggle: 'الحفظ داخل مجلد فرعي', placeholder: 'مثل lo-fi rips', invalid: 'اسم المجلد يحتوي على أحرف غير صالحة'}
		},
		output: {
			embedChapters: {label: 'تضمين الفصول', description: 'علامات فصول قابلة للتنقل في أي مشغّل حديث.'},
			embedMetadata: {label: 'تضمين البيانات الوصفية', description: 'كتابة العنوان والفنان والوصف وتاريخ الرفع في الملف.'},
			embedThumbnail: {label: 'تضمين الصورة المصغرة', description: 'صورة الغلاف داخل الملف. سيُعاد تغليف فيديو WebM إلى MKV؛ يُتخطى عند تضمين الترجمات.'},
			writeDescription: {label: 'حفظ الوصف', description: 'يحفظ وصف الفيديو كملف نصي .description بجانب التنزيل.'},
			writeThumbnail: {label: 'حفظ الصورة المصغرة', description: 'يحفظ الصورة المصغرة كملف صورة .jpg بجانب التنزيل.'},
			writeM3u: {label: 'إنشاء ملف قائمة تشغيل .m3u', description: 'يحفظ قائمة .m3u بجانب الفيديوهات كي تفتح بالترتيب في مشغل الوسائط.'}
		},
		confirm: {
	...
	videoCard: {titlePlaceholder: 'جارٍ التحميل…'},
	queue: {
	...
	presets: {
		'best-quality': {label: 'أفضل جودة', desc: 'أعلى دقة + أفضل صوت'},
		balanced: {label: 'متوازن', desc: '720p كحد أقصى + صوت جيد'},
		'audio-only': {label: 'صوت فقط', desc: 'بدون فيديو، أفضل صوت'},
		'small-file': {label: 'ملف صغير', desc: 'أدنى دقة + صوت منخفض'},
		'subtitle-only': {label: 'ترجمات فقط', desc: 'بدون فيديو، بدون صوت، ترجمات فقط'}
	},
	playlistPresets: {
		type: {video: 'Video', audio: 'Audio'},
		videoFormat: {best: 'Best codec', mp4: 'MP4 (H.264)'},
		videoFormatDesc: {best: 'أعلى ترميز متاح لكل عنصر', mp4: 'يفضّل H.264 + AAC، حاوية MP4 · أفضل محاولة'},
		tier: {best: 'Best quality', '2160': 'حتى 4K', '1440': 'حتى 1440p', '1080': 'حتى 1080p', '720': 'حتى 720p', '480': 'حتى 480p', '360': 'حتى 360p'},
		tierDesc: {best: 'أفضل فيديو + صوت متاح لكل عنصر', '2160': 'محدود عند 2160p ويهبط لكل عنصر عند الحاجة', '1440': 'محدود عند 2K ويهبط لكل عنصر عند الحاجة', '1080': 'محدود عند 1080p ويهبط لكل عنصر عند الحاجة', '720': 'ملفات أصغر وتوافق واسع', '480': 'Low bandwidth', '360': 'Smallest video'},
		audioFormat: {best: 'Audio (best)', mp3: 'MP3', m4a: 'M4A', opus: 'Opus'},
		audioFormatDesc: {best: 'أفضل صوت أصلي، بلا إعادة ترميز', mp3: 'تحويل إلى MP3', m4a: 'تحويل إلى M4A (AAC)', opus: 'تحويل إلى Opus'},
		audioFormatBitrate: 'Audio ({{format}} {{kbps}}K)',
		mp4Cap: 'H.264 أعلى من 1080p غير متاح على YouTube — يحد تلقائيًا إلى 1080p'
	},
	formatLabel: {audioFallback: 'صوت', audioOnlyDot: 'صوت فقط · {{audio}}', videoDot: '{{resolution}} · {{audio}}'},
	tray: {tooltip: 'Arroxy', menu: {statusIdle: 'خامل', statusActive_one: '1 جارٍ التنزيل · {{percent}}%', statusActive_other: '{{count}} جارٍ التنزيل · {{percent}}%', open: 'فتح Arroxy', quit: 'الخروج من Arroxy'}},
	dialogs: {
		quitWithActiveDownloads: {message_one: '{{count}} تنزيل قيد التقدم', message_other: '{{count}} تنزيلات قيد التقدم', detail: 'سيؤدي الإغلاق إلى إلغاء جميع التنزيلات النشطة.', confirm: 'إلغاء التنزيلات والخروج', keep: 'الاستمرار في التنزيل', pause: 'إيقاف التنزيلات مؤقتًا والخروج'},
		closeToTray: {message: 'هل تريد إخفاء Arroxy في علبة النظام عند الإغلاق؟', detail: 'يستمر Arroxy في العمل وينهي التنزيلات النشطة. يمكنك تغيير ذلك لاحقاً في الإعدادات المتقدمة.', hide: 'الإخفاء في علبة النظام', quit: 'الخروج', remember: 'لا تسألني مجدداً'},
		rendererCrashed: {message: 'واجه Arroxy مشكلة', detail: 'تعطّلت عملية العرض ({{reason}}). أعد التحميل للمحاولة مجدداً.', reload: 'إعادة التحميل', quit: 'الخروج'}
	},
	share: {
		title: 'مشاركة Arroxy',
