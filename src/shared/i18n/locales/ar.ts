const ar = {
  ...
  networkPacing: {
    ...
    presets: {
      off: {
        label: 'إيقاف',
        description: 'يستخدم فقط التوقفات الأساسية الصغيرة التي يحتفظ بها Arroxy للوسائط والترجمات.'
      },
      balanced: {
        label: 'متوازن',
        description: 'الافتراضي. يضيف توقفات قصيرة ويستخدم اتصال تنزيل واحد.'
      },
      careful: {
        label: 'حذر',
        description: 'يضيف توقفات أطول لقوائم التشغيل الكبيرة أو الشبكات التي تصل إلى الحدود بشكل متكرر.'
      },
      custom: {
        label: 'مخصص',
        description: 'اضبط بنفسك عناصر التحكم المتقدمة لكل تنزيل.'
      }
    },
    fields: {
