const ur = {
	common: {back: 'واپس', cancel: 'منسوخ کریں', continue: 'جاری رکھیں', retry: 'دوبارہ کوشش کریں', startOver: 'دوبارہ شروع کریں'},
	app: {feedback: 'فیڈبیک', logs: 'لاگز', feedbackNudge: 'Arroxy پسند آ رہا ہے؟ آپ سے سن کر خوشی ہو گی! 💬', debugCopied: 'کاپی ہو گیا!', debugCopyTitle: 'ڈیبگ معلومات کاپی کریں (Electron, OS, Chrome ورژنز)', zoomIn: 'زوم اِن', zoomOut: 'زوم آؤٹ'},
	about: {button: 'کے بارے میں', openTitle: 'Arroxy کے بارے میں', tagline: 'ڈیسک ٹاپ کے لیے تیز اور آسان ویڈیو اور آڈیو ڈاؤن لوڈر۔', websiteLink: 'ویب سائٹ', githubLink: 'GitHub', licenseLine: 'MIT لائسنس · از Antonio Orionus', thirdPartyNotices: 'فریق ثالث کے نوٹس دیکھیں'},
	titleBar: {close: 'بند کریں', minimize: 'چھوٹا کریں', maximize: 'بڑا کریں', restore: 'بحال کریں'},
	splash: {greeting: 'ارے، خوش آمدید!', warmup: 'Arroxy تیار ہو رہا ہے…', downloading: '{{binary}} ڈاؤن لوڈ ہو رہا ہے…', warmupFailedNoDiag: 'سیٹ اپ ناکام ہوا۔ تفصیلات کے لیے سیٹ اپ لاگ کھولیں۔'},
	repair: {
	...
	theme: {light: 'لائٹ موڈ', dark: 'ڈارک موڈ', system: 'سسٹم ڈیفالٹ'},
	language: {label: 'زبان'},
	wizard: {
		steps: {url: 'URL', playlistItems: 'Playlist', playlistPresets: 'معیار', formats: 'فارمیٹ', subtitles: 'سب ٹائٹلز', sponsorblock: 'SponsorBlock', output: 'آؤٹ پٹ', folder: 'محفوظ کریں', confirm: 'تصدیق'},
		playlist: {
		...
		url: {
			...
			features: {
				...
				youtube: {heading: 'YouTube', video: 'ویڈیوز', channel: 'چینلز', playlist: 'پلے لسٹس', short: 'Shorts', music: 'موسیقی', podcast: 'پوڈکاسٹ'},
				anySite: {heading: '2000+ سائٹس', video: 'ویڈیوز', videoPlaylist: 'ویڈیو پلے لسٹس', musicPlaylist: 'میوزک پلے لسٹس'},
				always: {heading: 'ہمیشہ دستیاب', audioOnly: 'صرف آڈیو', subtitles: 'سب ٹائٹلز'}
			},
			...
			proxy: {label: 'Proxy URL', description: 'پراکسی کے ذریعے ٹریفک روٹ کریں — جغرافیائی پابندی والے مواد کے لیے مفید۔', placeholder: 'http://host:port', clear: 'صاف کریں'},
			playlistProbeLimit: {
			...
			singleFilenameId: {toggle: 'سنگل فائل ناموں میں ویڈیو ID شامل کریں', toggleDescription: 'عنوان بدلنے یا ٹکرانے پر ایک بار کی ڈاؤن لوڈز کو منفرد رکھتا ہے۔'},
			networkPacing: {
				...
				presets: {off: 'بند', balanced: 'متوازن', careful: 'محتاط', custom: 'حسب ضرورت'},
				tooltips: {
				...
				fields: {sleepRequests: 'میٹا ڈیٹا چیکس کے درمیان انتظار', sleepInterval: 'میڈیا شروع ہونے سے پہلے وقفہ: کم از کم', maxSleepInterval: 'میڈیا شروع ہونے سے پہلے وقفہ: زیادہ سے زیادہ', concurrentFragments: 'ڈاؤن لوڈ کنکشنز', sleepSubtitles: 'سب ٹائٹل فائلوں سے پہلے انتظار'},
				presetLabel: 'Arroxy کتنی احتیاط کرے؟',
				units: {seconds: 'سیکنڈ', threads: 'تھریڈز'}
			},
			closeToTray: {toggle: 'بند کرنے پر ٹرے میں چھپائیں', toggleDescription: 'ونڈو بند ہونے کے بعد بیک گراؤنڈ میں ڈاؤن لوڈز جاری رکھیں۔'},
			analytics: {toggle: 'گمنام استعمال کے اعداد و شمار بھیجیں', toggleDescription: 'صرف ایپ لانچز گنتا ہے۔ کوئی URL، فائل نام، یا ذاتی ڈیٹا نہیں۔'},
			limitRate: {
		...
		subtitles: {
			...
			sectionManual: 'دستی',
			sectionAuto: 'خودکار',
			saveMode: {heading: 'محفوظ کریں بطور', sidecar: 'ویڈیو کے ساتھ', embed: 'ویڈیو میں شامل کریں', subfolder: 'subtitles/ سب فولڈر'},
			format: {heading: 'فارمیٹ'},
		...
		sponsorblock: {
			...
			mode: {off: 'بند', mark: 'چیپٹرز کے طور پر مارک کریں', remove: 'سیگمنٹس ہٹائیں'},
			modeHint: {off: 'کوئی SponsorBlock نہیں — ویڈیو ویسے ہی چلے گی جیسے اپلوڈ ہوئی۔', mark: 'سپانسر سیگمنٹس کو چیپٹرز کے طور پر مارک کرتا ہے (نقصان رہت)۔', remove: 'FFmpeg سے ویڈیو سے سپانسر سیگمنٹس کاٹ دیتا ہے۔'},
			categoriesHeading: 'کیٹیگریز',
			cat: {sponsor: 'سپانسر', intro: 'انٹرو', outro: 'آؤٹرو', selfpromo: 'سیلف پرومو', music_offtopic: 'موسیقی غیر متعلقہ', preview: 'پری ویو', filler: 'فِلر'}
		},
		formats: {
			...
			cookiesError: {
				...
				needsCookies: {heading: 'اس سائٹ کو سائن اِن ضروری ہے', body: 'yt-dlp تصدیق کے بغیر اس ویڈیو تک رسائی حاصل نہیں کر سکا۔ ایڈوانسڈ سیٹنگز میں cookies ترتیب دیں — کسی ایسے براؤزر کی طرف اشارہ کریں جس میں آپ پہلے سے سائن اِن ہوں، یا cookies.txt فائل درآمد کریں۔'},
				dpapi: {
		...
		folder: {heading: 'محفوظ کریں', downloads: 'Downloads', videos: 'Movies', desktop: 'Desktop', music: 'Music', documents: 'Documents', pictures: 'Pictures', home: 'Home', custom: 'حسب ضرورت…', subfolder: {toggle: 'سب فولڈر میں محفوظ کریں', placeholder: 'مثلاً lo-fi rips', invalid: 'فولڈر کے نام میں غلط حروف ہیں'}},
		output: {
			embedChapters: {label: 'چیپٹرز شامل کریں', description: 'چیپٹر مارکرز کسی بھی جدید پلیئر میں نیویگیٹ کیے جا سکتے ہیں۔'},
			embedMetadata: {label: 'میٹا ڈیٹا شامل کریں', description: 'عنوان، فنکار، تفصیل، اور اپلوڈ کی تاریخ فائل میں لکھی جاتی ہے۔'},
			embedThumbnail: {label: 'تھمب نیل شامل کریں', description: 'فائل میں کور آرٹ۔ WebM ویڈیو کو MKV میں ری مکس کیا جائے گا؛ جب سب ٹائٹلز شامل ہوں تو چھوڑ دیا جاتا ہے۔'},
			writeDescription: {label: 'تفصیل محفوظ کریں', description: 'ویڈیو کی تفصیل کو ڈاؤن لوڈ کے ساتھ .description ٹیکسٹ فائل کے طور پر محفوظ کرتا ہے۔'},
			writeThumbnail: {label: 'تھمب نیل محفوظ کریں', description: 'تھمب نیل کو ڈاؤن لوڈ کے ساتھ .jpg امیج فائل کے طور پر محفوظ کرتا ہے۔'},
			writeM3u: {label: '.m3u پلے لسٹ فائل بنائیں', description: 'ویڈیوز کے ساتھ .m3u پلے لسٹ محفوظ کرتا ہے تاکہ وہ میڈیا پلیئر میں ترتیب سے کھلیں۔'}
		},
		confirm: {
	...
	videoCard: {titlePlaceholder: 'لوڈ ہو رہا ہے…'},
	queue: {
	...
	presets: {
		'best-quality': {label: 'بہترین کوالٹی', desc: 'سب سے زیادہ ریزولوشن + بہترین آڈیو'},
		balanced: {label: 'متوازن', desc: '720p زیادہ سے زیادہ + اچھی آڈیو'},
		'audio-only': {label: 'صرف آڈیو', desc: 'کوئی ویڈیو نہیں، بہترین آڈیو'},
		'small-file': {label: 'چھوٹی فائل', desc: 'سب سے کم ریزولوشن + کم آڈیو'},
		'subtitle-only': {label: 'صرف سب ٹائٹلز', desc: 'کوئی ویڈیو نہیں، کوئی آڈیو نہیں، صرف سب ٹائٹلز'}
	},
	playlistPresets: {
		type: {video: 'Video', audio: 'Audio'},
		videoFormat: {best: 'Best codec', mp4: 'MP4 (H.264)'},
		videoFormatDesc: {best: 'ہر آئٹم کے لیے سب سے اعلیٰ دستیاب کوڈیک', mp4: 'H.264 + AAC ترجیحی، MP4 کنٹینر · بہترین کوشش'},
		tier: {best: 'Best quality', '2160': '4K تک', '1440': '1440p تک', '1080': '1080p تک', '720': '720p تک', '480': '480p تک', '360': '360p تک'},
		tierDesc: {best: 'ہر آئٹم کے لیے بہترین ویڈیو + آڈیو', '2160': '2160p تک محدود، ہر آئٹم پر ضرورت ہو تو کم', '1440': '2K تک محدود، ہر آئٹم پر ضرورت ہو تو کم', '1080': '1080p تک محدود، ہر آئٹم پر ضرورت ہو تو کم', '720': 'چھوٹی فائلیں، وسیع مطابقت', '480': 'Low bandwidth', '360': 'Smallest video'},
		audioFormat: {best: 'Audio (best)', mp3: 'MP3', m4a: 'M4A', opus: 'Opus'},
		audioFormatDesc: {best: 'بہترین اصل آڈیو، دوبارہ encode نہیں', mp3: 'MP3 میں تبدیل کریں', m4a: 'M4A (AAC) میں تبدیل کریں', opus: 'Opus میں تبدیل کریں'},
		audioFormatBitrate: 'Audio ({{format}} {{kbps}}K)',
		mp4Cap: 'YouTube پر 1080p سے اوپر H.264 دستیاب نہیں — خودکار طور پر 1080p تک محدود'
	},
	formatLabel: {audioFallback: 'آڈیو', audioOnlyDot: 'صرف آڈیو · {{audio}}', videoDot: '{{resolution}} · {{audio}}'},
	tray: {tooltip: 'Arroxy', menu: {statusIdle: 'فارغ', statusActive_one: '1 ڈاؤن لوڈ ہو رہا ہے · {{percent}}%', statusActive_other: '{{count}} ڈاؤن لوڈ ہو رہے ہیں · {{percent}}%', open: 'Arroxy کھولیں', quit: 'Arroxy بند کریں'}},
	dialogs: {
		quitWithActiveDownloads: {message_one: '{{count}} ڈاؤن لوڈ جاری ہے', message_other: '{{count}} ڈاؤن لوڈز جاری ہیں', detail: 'بند کرنے سے تمام ایکٹو ڈاؤن لوڈز منسوخ ہو جائیں گے۔', confirm: 'ڈاؤن لوڈز منسوخ کریں اور بند کریں', keep: 'ڈاؤن لوڈ جاری رکھیں', pause: 'ڈاؤن لوڈز روک کر بند کریں'},
		closeToTray: {message: 'بند کرتے وقت Arroxy کو سسٹم ٹرے میں چھپائیں؟', detail: 'Arroxy چلتا رہتا ہے اور ایکٹو ڈاؤن لوڈز مکمل کرتا ہے۔ یہ بعد میں ایڈوانسڈ سیٹنگز سے بدلیں۔', hide: 'ٹرے میں چھپائیں', quit: 'بند کریں', remember: 'دوبارہ مت پوچھیں'},
		rendererCrashed: {message: 'Arroxy کو ایک مسئلے کا سامنا ہوا', detail: 'رینڈرر پراسیس کریش ہو گیا ({{reason}})۔ دوبارہ کوشش کرنے کے لیے ری لوڈ کریں۔', reload: 'ری لوڈ', quit: 'بند کریں'}
	},
	share: {
