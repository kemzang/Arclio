const es = {
	common: {back: 'Atrás', cancel: 'Cancelar', continue: 'Continuar', retry: 'Reintentar', startOver: 'Empezar de nuevo'},
	app: {feedback: 'Comentarios', logs: 'Registros', feedbackNudge: '¿Disfrutando Arroxy? ¡Me encantaría saber de ti! 💬', debugCopied: '¡Copiado!', debugCopyTitle: 'Copiar info de depuración (versiones de Electron, OS, Chrome)', zoomIn: 'Acercar', zoomOut: 'Alejar'},
	about: {button: 'Acerca de', openTitle: 'Acerca de Arroxy', tagline: 'Descargador de vídeo y audio rápido y sencillo para escritorio.', websiteLink: 'Sitio web', githubLink: 'GitHub', licenseLine: 'Licencia MIT · por Antonio Orionus', thirdPartyNotices: 'Ver avisos de terceros'},
	titleBar: {close: 'Cerrar', minimize: 'Minimizar', maximize: 'Maximizar', restore: 'Restaurar'},
	splash: {greeting: '¡Hey, bienvenido de vuelta!', warmup: 'Arroxy se está preparando…', downloading: 'Descargando {{binary}}…', warmupFailedNoDiag: 'Error en la configuración. Abre el registro de configuración para más detalles.'},
	repair: {
	...
	theme: {light: 'Modo claro', dark: 'Modo oscuro', system: 'Predeterminado del sistema'},
	language: {label: 'Idioma'},
	wizard: {
		steps: {url: 'URL', playlistItems: 'Playlist', playlistPresets: 'Calidad', formats: 'Formato', subtitles: 'Subtítulos', sponsorblock: 'SponsorBlock', output: 'Salida', folder: 'Guardar', confirm: 'Confirmar'},
		playlist: {
		...
		url: {
			...
			features: {
				...
				youtube: {heading: 'YouTube', video: 'Vídeos', channel: 'Canales', playlist: 'Playlists', short: 'Shorts', music: 'Música', podcast: 'Podcasts'},
				anySite: {heading: '2000+ sitios', video: 'Vídeos', videoPlaylist: 'Playlists de vídeo', musicPlaylist: 'Playlists de música'},
				always: {heading: 'Siempre disponible', audioOnly: 'Solo audio', subtitles: 'Subtítulos'}
			},
			...
			proxy: {label: 'Proxy URL', description: 'Enruta el tráfico a través de un proxy — útil para contenido con restricciones geográficas.', placeholder: 'http://host:port', clear: 'Borrar'},
			playlistProbeLimit: {
			...
			singleFilenameId: {toggle: 'Añadir ID del vídeo a nombres de archivo individuales', toggleDescription: 'Mantiene únicas las descargas sueltas cuando los títulos cambian o coinciden.'},
			networkPacing: {
				...
				presets: {off: 'Desactivado', balanced: 'Equilibrado', careful: 'Cuidadoso', custom: 'Personalizado'},
				tooltips: {
				...
				fields: {sleepRequests: 'Pausa entre comprobaciones de metadatos', sleepInterval: 'Pausa antes de iniciar el medio: mín', maxSleepInterval: 'Pausa antes de iniciar el medio: máx', sleepSubtitles: 'Pausa antes de archivos de subtítulos', concurrentFragments: 'Conexiones de descarga'},
				units: {seconds: 'seg', threads: 'hilos'}
			},
			closeToTray: {toggle: 'Minimizar a la bandeja al cerrar', toggleDescription: 'Continuar descargas en segundo plano al cerrar la ventana.'},
			analytics: {toggle: 'Enviar estadísticas de uso anónimas', toggleDescription: 'Solo cuenta los inicios de la app. Sin URLs, nombres de archivo ni datos personales.'},
			limitRate: {
		...
		subtitles: {
			...
			saveMode: {heading: 'Guardar como', sidecar: 'Junto al vídeo', embed: 'Incrustar en el vídeo', subfolder: 'Subcarpeta subtitles/'},
		...
		sponsorblock: {
			...
			mode: {off: 'Desactivado', mark: 'Marcar como capítulos', remove: 'Eliminar segmentos'},
			modeHint: {off: 'Sin SponsorBlock — el vídeo se reproduce tal cual fue subido.', mark: 'Marca segmentos de sponsor como capítulos (no destructivo).', remove: 'Elimina segmentos de sponsor del vídeo con FFmpeg.'},
			categoriesHeading: 'Categorías',
			cat: {sponsor: 'Patrocinio', intro: 'Intro', outro: 'Outro', selfpromo: 'Autopromoción', music_offtopic: 'Música fuera de tema', preview: 'Vista previa', filler: 'Relleno'}
		},
		formats: {
			...
			cookiesError: {
				...
				needsCookies: {heading: 'Este sitio requiere inicio de sesión', body: 'yt-dlp no pudo acceder a este vídeo sin autenticación. Configura las cookies en los ajustes avanzados — apúntalas a un navegador en el que ya hayas iniciado sesión o importa un archivo cookies.txt.'},
				dpapi: {
		...
		folder: {
			...
			custom: 'Personalizado…',
			subfolder: {toggle: 'Guardar en subcarpeta', placeholder: 'p. ej. lo-fi rips', invalid: 'El nombre tiene caracteres no válidos'}
		},
		output: {
			embedChapters: {label: 'Incrustar capítulos', description: 'Marcadores de capítulo navegables en cualquier reproductor moderno.'},
			embedMetadata: {label: 'Incrustar metadatos', description: 'Título, artista, descripción y fecha de subida escritos en el archivo.'},
			embedThumbnail: {label: 'Incrustar miniatura', description: 'Portada dentro del archivo. El vídeo WebM se remultiplexará a MKV; se omite al incrustar subtítulos.'},
			writeDescription: {label: 'Guardar descripción', description: 'Guarda la descripción del vídeo como archivo .description junto a la descarga.'},
			writeThumbnail: {label: 'Guardar miniatura', description: 'Guarda la miniatura como archivo .jpg junto a la descarga.'},
			writeM3u: {label: 'Generar archivo de playlist .m3u', description: 'Guarda una playlist .m3u junto a los vídeos para abrirlos en orden en tu reproductor.'}
		},
		confirm: {
	...
	videoCard: {titlePlaceholder: 'Cargando…'},
	queue: {
	...
	presets: {
		'best-quality': {label: 'Mejor calidad', desc: 'Resolución máxima + mejor audio'},
		balanced: {label: 'Equilibrado', desc: '720p máx + buen audio'},
		'audio-only': {label: 'Solo audio', desc: 'Sin vídeo, mejor audio'},
		'small-file': {label: 'Archivo pequeño', desc: 'Resolución mínima + audio bajo'},
		'subtitle-only': {label: 'Solo subtítulos', desc: 'Sin vídeo ni audio, solo subtítulos'}
	},
	playlistPresets: {
		type: {video: 'Video', audio: 'Audio'},
		videoFormat: {best: 'Best codec', mp4: 'MP4 (H.264)'},
		videoFormatDesc: {best: 'Códec más alto disponible por elemento', mp4: 'H.264 + AAC preferido, contenedor MP4 · mejor esfuerzo'},
		tier: {best: 'Best quality', '2160': 'Hasta 4K', '1440': 'Hasta 1440p', '1080': 'Hasta 1080p', '720': 'Hasta 720p', '480': 'Hasta 480p', '360': 'Hasta 360p'},
		tierDesc: {
		...
		audioFormatDesc: {best: 'Mejor audio nativo, sin recodificar', mp3: 'Convertir a MP3', m4a: 'Convertir a M4A (AAC)', opus: 'Convertir a Opus'},
	...
	formatLabel: {audioFallback: 'Audio', audioOnlyDot: 'Solo audio · {{audio}}', videoDot: '{{resolution}} · {{audio}}'},
	tray: {tooltip: 'Arroxy', menu: {statusIdle: 'Inactivo', statusActive_one: '1 descargando · {{percent}}%', statusActive_other: '{{count}} descargando · {{percent}}%', open: 'Abrir Arroxy', quit: 'Salir de Arroxy'}},
	dialogs: {
		quitWithActiveDownloads: {message_one: '{{count}} descarga en curso', message_other: '{{count}} descargas en curso', detail: 'Cerrar cancelará todas las descargas activas.', confirm: 'Cancelar descargas y salir', keep: 'Seguir descargando', pause: 'Pausar descargas y salir'},
		closeToTray: {message: '¿Ocultar Arroxy en la bandeja del sistema al cerrar?', detail: 'Arroxy sigue ejecutándose y termina las descargas activas. Cámbialo en Ajustes avanzados.', hide: 'Ocultar en bandeja', quit: 'Salir', remember: 'No volver a preguntar'},
		rendererCrashed: {message: 'Arroxy encontró un problema', detail: 'El proceso de renderizado falló ({{reason}}). Recarga para intentarlo de nuevo.', reload: 'Recargar', quit: 'Salir'}
	},
	share: {
