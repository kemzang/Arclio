const om = {
	common: {back: 'Duubatti', cancel: 'Haqi', continue: 'Itti fufi', retry: "Irra deebi'i", startOver: "Jalqabbii irra deebi'i"},
	app: {feedback: 'Yaada', logs: 'Galmee', feedbackNudge: "Arroxy si gammachiisaa jiraa? Yaada kee dhaga'uu barbaada! 💬", debugCopied: "Koopii ta'e!", debugCopyTitle: 'Odeeffannoo dhibdee koopii godhi (Electron, OS, Chrome versiiwwan)', zoomIn: 'Guddisi', zoomOut: 'Xiqqeessi'},
	about: {button: "Waa'ee", openTitle: "Waa'ee Arroxy", tagline: 'Buufataa viidiyoo fi sagalee ariifataa fi miidhaaginaan desktop irratti.', websiteLink: 'Marsariitii', githubLink: 'GitHub', licenseLine: 'Heeyyama MIT · by Antonio Orionus', thirdPartyNotices: 'Beeksisa seera-biroo ilaali'},
	titleBar: {close: 'Cufii', minimize: 'Xiqqeessi', maximize: 'Guddisi', restore: "Deebi'si"},
	splash: {greeting: 'Baga nagaan deebitee!', warmup: "Arroxy qophaa'aa jira…", downloading: '{{binary}} buufatamaa jira…', warmupFailedNoDiag: "Qindaa'inni hin milkoofne. Bal'ina argachuuf galmee qindaa'inaa bani."},
	repair: {
	...
	theme: {light: 'Haala iftoomaa', dark: 'Haala gurraacha', system: 'Sirna durtii'},
	language: {label: 'Afaan'},
	wizard: {
		steps: {url: 'URL', playlistItems: 'Playlist', playlistPresets: 'Qulqullina', formats: 'Foormaatii', subtitles: 'Axxiinni', sponsorblock: 'SponsorBlock', output: "Ba'uu", folder: 'Kuusi', confirm: 'Mirkaneessi'},
		playlist: {
		...
		url: {
			...
			features: {
				...
				youtube: {heading: 'YouTube', video: 'Viidiyoowwan', channel: 'Channelota', playlist: 'Playlists', short: 'Shorts', music: 'Muuziqaa', podcast: 'Podcastota'},
				anySite: {heading: 'Gareewwan 2000+', video: 'Viidiyoowwan', videoPlaylist: 'Playlist viidiyoo', musicPlaylist: 'Playlist muuziqaa'},
				always: {heading: 'Yeroo hundaa ni argama', audioOnly: 'Sagalee qofa', subtitles: 'Axxiinni'}
			},
			...
			proxy: {label: 'Proxy URL', description: 'Geejjiba proxy darbii ergi — qabiyyee mootummaan dhorge argachuuf gargaara.', placeholder: 'http://host:port', clear: 'Haquu'},
			playlistProbeLimit: {
			...
			singleFilenameId: {toggle: 'Maqaa faayila tokko tokkootti ID viidiyoo dabali', toggleDescription: 'Mata dureewwan yeroo jijjiiraman ykn walitti bu’an buufata tokko tokko adda taasisa.'},
			networkPacing: {
				...
				presets: {off: 'Dhaabbi', balanced: 'Walsimu', careful: 'Of-eeggannaa', custom: "Ofiin qindi'i"},
				tooltips: {
				...
				fields: {sleepRequests: 'Qorannoo metadata gidduutti eegii', sleepInterval: 'Miidiyaan jalqabuuf dura gidduu dhabi: isa xiqqaa', maxSleepInterval: "Miidiyaan jalqabuuf dura gidduu dhabi: isa ol'aanaa", sleepSubtitles: 'Axxiinni faayiloota dura eegii', concurrentFragments: 'Walqunnamtii buufata'},
				units: {seconds: 'sec', threads: 'threads'}
			},
			closeToTray: {toggle: 'Cufuun dura tiiree dhoksi', toggleDescription: 'Daawniloodii booda gubbaan cufamuu itti fufi.'},
			analytics: {toggle: 'Tilastoo faayidaa maqaa-malee ergaa', toggleDescription: 'Jalqabbii app qofa lakkaawa. URL, maqaa faayilii, ykn daataa dhuunfaa hin qabatu.'},
			limitRate: {
		...
		subtitles: {
			...
			saveMode: {heading: 'Akkamitti kuusi', sidecar: 'Viidiyoo cinaa', embed: 'Viidiyoo keessatti maksi', subfolder: 'subtitles/ saab-foldarii'},
			format: {heading: 'Foormaatii'},
		...
		sponsorblock: {
			...
			mode: {off: 'Dhaabbi', mark: "Boqonnaa ta'ee mallattaa'i", remove: 'Kutaalee haquu'},
			modeHint: {off: "SponsorBlock hin jiru — viidiyoon akka fe'ametti taphatama.", mark: "Kutaalee dhiibbaa boqonnaa ta'ee mallattaa'a (miidhaa hin qabne).", remove: 'FFmpeg fayyadamuun kutaalee dhiibbaa muqa.'},
		...
		formats: {
			...
			cookiesError: {
				...
				needsCookies: {heading: 'Gareewwan kun seensa gaafata', body: "yt-dlp viidiyoo kana mirkaneessuu malee argachuu hin danda'u. Qindaa'inoota ammayyaa keessatti cookies qopheessi — browser seenite irra qeensi, ykn faayilii cookies.txt galchi."},
				dpapi: {
		...
		folder: {
			...
			home: 'Mana',
			custom: "Ofiin kaa'i…",
			subfolder: {toggle: 'Saab-foldarii keessatti kuusi', placeholder: 'fkn lo-fi rips', invalid: 'Maqaan foldarii mallattoolee sirrii hin qabu'}
		},
		output: {
			embedChapters: {label: 'Boqonnaa maksi', description: 'Mallattooleen boqonnaa taphataa ammayyaa kamiyyuu keessatti hojjetu.'},
			embedMetadata: {label: 'Metadata maksi', description: "Mata-duree, artist, ibsa, fi guyyaan fe'ame faayilii keessatti barreeffama."},
			embedThumbnail: {label: 'Thumbnail maksi', description: 'Suuraa haguugduu faayilii keessa. MP4 / M4A qofa — axxiinni makamuun dura ni darba.'},
			writeDescription: {label: 'Ibsa kuusi', description: "Ibsa viidiyoo .description faayilii barreeffamaa ta'ee daawniloodii cinaa ni kuusa."},
			writeThumbnail: {label: 'Thumbnail kuusi', description: "Thumbnail .jpg faayilii suuraa ta'ee daawniloodii cinaa ni kuusa."},
			writeM3u: {label: 'Faayilii playlist .m3u uumi', description: 'Viidiyoowwan tarreen media player keessatti banamaniif .m3u isaan cinatti kuusi.'}
		},
		confirm: {
	...
	videoCard: {titlePlaceholder: "Fe'amaa jira…"},
	queue: {
	...
	presets: {
		'best-quality': {label: "Qulqullina ol'aanaa", desc: "Firiimii ol'aanaa + sagalee caalmaa"},
		balanced: {label: 'Walsimu', desc: "720p ol'aanaa + sagalee gaarii"},
		'audio-only': {label: 'Sagalee qofa', desc: 'Viidiyoo hin jiru, sagalee caalmaa'},
		'small-file': {label: 'Faayilii xiqqaa', desc: 'Firiimii gadi aanaa + sagalee gadi aanaa'},
		'subtitle-only': {label: 'Axxiinni qofa', desc: 'Viidiyoo hin jiru, sagalee hin jiru, axxiinni qofa'}
	},
	playlistPresets: {
		type: {video: 'Video', audio: 'Audio'},
		videoFormat: {best: 'Best codec', mp4: 'MP4 (H.264)'},
		videoFormatDesc: {best: 'Codec ol’aanaa argamu tokkoon tokkoon wantaaf', mp4: 'H.264 + AAC filatama, konteenera MP4 · carraa gaarii'},
		tier: {best: 'Best quality', '2160': 'Hanga 4K', '1440': 'Hanga 1440p', '1080': 'Hanga 1080p', '720': 'Hanga 720p', '480': 'Hanga 480p', '360': 'Hanga 360p'},
		tierDesc: {
		...
		audioFormatDesc: {best: 'Sagalee native ol’aanaa, irra deebi’ee hin encode’u', mp3: 'Gara MP3 jijjiiri', m4a: 'Gara M4A (AAC) jijjiiri', opus: 'Gara Opus jijjiiri'},
		audioFormatBitrate: 'Audio ({{format}} {{kbps}}K)',
		mp4Cap: 'H.264 1080p olii YouTube irratti hin jiru — ofumaan 1080p irratti daangeffama'
	},
	formatLabel: {audioFallback: 'Sagalee', audioOnlyDot: 'Sagalee qofa · {{audio}}', videoDot: '{{resolution}} · {{audio}}'},
	tray: {tooltip: 'Arroxy', menu: {statusIdle: 'Boqachaa', statusActive_one: '1 buufamaa jira · {{percent}}%', statusActive_other: '{{count}} buufamaa jiru · {{percent}}%', open: 'Arroxy bani', quit: 'Arroxy cufii'}},
	dialogs: {
		quitWithActiveDownloads: {message_one: 'Daawniloodii {{count}} adeemaa jira', message_other: 'Daawniloodoonni {{count}} adeemaa jiru', detail: 'Cufuun daawniloodoonni hundi haqama.', confirm: 'Daawniloodii Haqi fi Cufii', keep: 'Daawniloodii itti fufi', pause: 'Buusuu dhaabiitii ba’i'},
		closeToTray: {message: 'Cufuun Arroxy tiiree irratti dhoksi?', detail: "Arroxy hojjechuuf itti fufa daawniloodoonnis xumurama. Booda Qindaa'inoota Ammayyaa keessatti jijjiiri.", hide: 'Tiiree irratti dhoksi', quit: 'Cufii', remember: 'Gara fuula duraatti hin gaafatin'},
		rendererCrashed: {message: 'Arroxy rakkoo mudateera', detail: "Prosessiin renderer kufee ({{reason}}). Irra deebi'uuf fe'adhu.", reload: "Fe'adhu", quit: 'Cufii'}
	},
	share: {
		title: 'Arroxy Qoodi',
