  ...
  wizard: {
    ...
    url: {
      ...
      networkPacing: {
        ...
        fields: {
          sleepRequests: 'Metadata စစ်ဆေးမှုများကြား ဆိုင်းငံ့ချိန်',
          sleepInterval: 'Media မစတင်မီ ခေတ္တရပ်ချိန်: အနိမ့်',
          maxSleepInterval: 'Media မစတင်မီ ခေတ္တရပ်ချိန်: အမြင့်',
          sleepSubtitles: 'စာတန်းထိုးဖိုင်များမတိုင်မီ ဆိုင်းငံ့ချိန်',
          concurrentFragments: 'ဒေါင်းလုဒ်ချိတ်ဆက်မှုများ'
        },
        units: {
          seconds: 'စက္ကန့်',
          threads: 'threads'
