const bn = {
	common: {back: 'পেছনে', cancel: 'বাতিল', continue: 'চালিয়ে যান', retry: 'আবার চেষ্টা করুন', startOver: 'নতুন করে শুরু করুন'},
	app: {feedback: 'মতামত', logs: 'লগ', feedbackNudge: 'Arroxy পছন্দ হচ্ছে? আপনার মতামত জানাতে চাই! 💬', debugCopied: 'কপি হয়েছে!', debugCopyTitle: 'ডিবাগ তথ্য কপি করুন (Electron, OS, Chrome সংস্করণ)', zoomIn: 'জুম ইন', zoomOut: 'জুম আউট'},
	about: {button: 'সম্পর্কে', openTitle: 'Arroxy সম্পর্কে', tagline: 'ডেস্কটপের জন্য দ্রুত ও সহজ ভিডিও ও অডিও ডাউনলোডার।', websiteLink: 'ওয়েবসাইট', githubLink: 'GitHub', licenseLine: 'MIT লাইসেন্স · Antonio Orionus দ্বারা', thirdPartyNotices: 'তৃতীয়-পক্ষ নোটিশ দেখুন'},
	titleBar: {close: 'বন্ধ করুন', minimize: 'ছোট করুন', maximize: 'বড় করুন', restore: 'পুনরুদ্ধার করুন'},
	splash: {greeting: 'স্বাগতম, আবার এলেন!', warmup: 'Arroxy প্রস্তুত হচ্ছে…', downloading: '{{binary}} ডাউনলোড হচ্ছে…', warmupFailedNoDiag: 'সেটআপ ব্যর্থ হয়েছে। বিস্তারিত জানতে সেটআপ লগ খুলুন।'},
	repair: {
		...
		actions: {chooseExecutable: 'এক্সিকিউটেবল বেছে নিন', installWithHomebrew: 'Homebrew দিয়ে ইনস্টল করুন', installWithWinget: 'WinGet দিয়ে ইনস্টল করুন', resetToDefault: 'ডিফল্টে ফিরুন', retrySetup: 'সেটআপ আবার চেষ্টা করুন', cancel: 'বাতিল', openDependencyFolder: 'ডিপেনডেন্সি ফোল্ডার খুলুন', viewSetupLog: 'সেটআপ লগ দেখুন'}
	},
	theme: {light: 'লাইট মোড', dark: 'ডার্ক মোড', system: 'সিস্টেম ডিফল্ট'},
	language: {label: 'ভাষা'},
	wizard: {
		steps: {url: 'URL', playlistItems: 'Playlist', playlistPresets: 'মান', formats: 'ফরম্যাট', subtitles: 'সাবটাইটেল', sponsorblock: 'SponsorBlock', output: 'আউটপুট', folder: 'সেভ', confirm: 'নিশ্চিত করুন'},
		playlist: {
		...
		url: {
			...
			features: {
				...
				youtube: {heading: 'YouTube', video: 'ভিডিও', channel: 'চ্যানেল', playlist: 'Playlist', short: 'Shorts', music: 'মিউজিক', podcast: 'Podcast'},
				anySite: {heading: '2000+ সাইট', video: 'ভিডিও', videoPlaylist: 'ভিডিও playlist', musicPlaylist: 'মিউজিক playlist'},
				always: {heading: 'সবসময় উপলব্ধ', audioOnly: 'শুধু অডিও', subtitles: 'সাবটাইটেল'}
			},
			...
			proxy: {label: 'Proxy URL', description: 'প্রক্সির মাধ্যমে ট্র্যাফিক রাউট করুন — ভৌগোলিকভাবে সীমাবদ্ধ কন্টেন্টের জন্য উপযোগী।', placeholder: 'http://host:port', clear: 'মুছুন'},
			singleFilenameId: {toggle: 'একক ফাইলনামে ভিডিও ID যোগ করুন', toggleDescription: 'শিরোনাম বদলালে বা মিলে গেলে এককালীন ডাউনলোডগুলোকে আলাদা রাখে।'},
			networkPacing: {
				...
				presets: {off: 'বন্ধ', balanced: 'সুষম', careful: 'সতর্ক', custom: 'কাস্টম'},
				tooltips: {off: 'শুধুমাত্র Arroxy যে ছোট বেসলাইন বিরতি মিডিয়া ও সাবটাইটেলের জন্য রাখে তা ব্যবহার করে।', balanced: 'ডিফল্ট। ছোট বিরতি যোগ করে এবং একটি ডাউনলোড সংযোগ ব্যবহার করে।', careful: 'বড় প্লেলিস্ট বা যে নেটওয়ার্কে প্রায়ই সীমা লাগে তার জন্য দীর্ঘ বিরতি যোগ করে।', custom: 'ডাউনলোডের উন্নত নিয়ন্ত্রণগুলো নিজে সেট করুন।'},
				fields: {sleepRequests: 'মেটাডেটা চেকের মাঝে বিরতি', sleepInterval: 'মিডিয়া শুরুর আগে বিরতি: সর্বনিম্ন', maxSleepInterval: 'মিডিয়া শুরুর আগে বিরতি: সর্বোচ্চ', sleepSubtitles: 'সাবটাইটেল ফাইলের আগে বিরতি', concurrentFragments: 'ডাউনলোড সংযোগ'},
				units: {seconds: 'সে', threads: 'থ্রেড'}
			},
			playlistProbeLimit: {
			...
			closeToTray: {toggle: 'বন্ধে ট্রেতে লুকান', toggleDescription: 'উইন্ডো বন্ধ করার পরেও ব্যাকগ্রাউন্ডে ডাউনলোড চলতে থাকবে।'},
			analytics: {toggle: 'বেনামী ব্যবহার পরিসংখ্যান পাঠান', toggleDescription: 'শুধুমাত্র অ্যাপ চালু হওয়ার সংখ্যা গণনা করে। কোনো URL, ফাইলের নাম বা ব্যক্তিগত তথ্য নেই।'},
			limitRate: {
		...
		subtitles: {
			...
			saveMode: {heading: 'সেভ করুন', sidecar: 'ভিডিওর পাশে', embed: 'ভিডিওতে এম্বেড করুন', subfolder: 'subtitles/ সাবফোল্ডার'},
			format: {heading: 'ফরম্যাট'},
		...
		sponsorblock: {
			...
			mode: {off: 'বন্ধ', mark: 'চ্যাপ্টার হিসেবে চিহ্নিত করুন', remove: 'সেগমেন্ট সরান'},
			modeHint: {off: 'কোনো SponsorBlock নেই — ভিডিও আপলোড করা অবস্থায় চলবে।', mark: 'স্পনসর সেগমেন্টকে চ্যাপ্টার হিসেবে চিহ্নিত করে (নন-ডেস্ট্রাক্টিভ)।', remove: 'FFmpeg ব্যবহার করে ভিডিও থেকে স্পনসর সেগমেন্ট কেটে ফেলে।'},
			categoriesHeading: 'ক্যাটাগরি',
			cat: {sponsor: 'স্পনসর', intro: 'ইন্ট্রো', outro: 'আউট্রো', selfpromo: 'সেলফ-প্রোমো', music_offtopic: 'অপ্রাসঙ্গিক মিউজিক', preview: 'প্রিভিউ', filler: 'ফিলার'}
		},
		formats: {
			...
			cookiesError: {
				...
				needsCookies: {heading: 'এই সাইটে সাইন-ইন প্রয়োজন', body: 'yt-dlp প্রমাণীকরণ ছাড়া এই ভিডিওতে অ্যাক্সেস করতে পারেনি। উন্নত সেটিংসে কুকিজ কনফিগার করুন — আপনি ইতিমধ্যে সাইন ইন করা কোনো ব্রাউজার দিন, বা cookies.txt ফাইল আমদানি করুন।'},
				dpapi: {
		...
		folder: {heading: 'সেভ করুন', downloads: 'ডাউনলোড', videos: 'মুভিজ', desktop: 'ডেস্কটপ', music: 'মিউজিক', documents: 'ডকুমেন্টস', pictures: 'ছবি', home: 'হোম', custom: 'কাস্টম…', subfolder: {toggle: 'সাবফোল্ডারে সেভ করুন', placeholder: 'যেমন lo-fi rips', invalid: 'ফোল্ডার নামে অবৈধ অক্ষর আছে'}},
		output: {
			embedChapters: {label: 'চ্যাপ্টার এম্বেড করুন', description: 'যেকোনো আধুনিক প্লেয়ারে নেভিগেট করা যায় এমন চ্যাপ্টার মার্কার।'},
			embedMetadata: {label: 'মেটাডেটা এম্বেড করুন', description: 'শিরোনাম, শিল্পী, বিবরণ এবং আপলোড তারিখ ফাইলে লেখা হবে।'},
			embedThumbnail: {label: 'থাম্বনেইল এম্বেড করুন', description: 'ফাইলের ভেতরে কভার আর্ট। WebM ভিডিও MKV-তে রিমাক্স করা হবে; সাবটাইটেল এম্বেড থাকলে বাদ দেওয়া হবে।'},
			writeDescription: {label: 'বিবরণ সেভ করুন', description: 'ভিডিও বিবরণ ডাউনলোডের পাশে .description টেক্সট ফাইল হিসেবে সেভ করে।'},
			writeThumbnail: {label: 'থাম্বনেইল সেভ করুন', description: 'থাম্বনেইল ডাউনলোডের পাশে .jpg ইমেজ ফাইল হিসেবে সেভ করে।'},
			writeM3u: {label: '.m3u প্লেলিস্ট ফাইল তৈরি করুন', description: 'ভিডিওগুলোর পাশে .m3u প্লেলিস্ট সংরক্ষণ করে যাতে মিডিয়া প্লেয়ারে ক্রম অনুযায়ী খোলে।'}
		},
		confirm: {
	...
	videoCard: {titlePlaceholder: 'লোড হচ্ছে…'},
	queue: {
		header: 'ডাউনলোড কিউ',
	...
	presets: {
		'best-quality': {label: 'সর্বোচ্চ মান', desc: 'সর্বোচ্চ রেজোলিউশন + সেরা অডিও'},
		balanced: {label: 'সুষম', desc: '720p সর্বোচ্চ + ভালো অডিও'},
		'audio-only': {label: 'শুধু অডিও', desc: 'ভিডিও নেই, সেরা অডিও'},
		'small-file': {label: 'ছোট ফাইল', desc: 'সর্বনিম্ন রেজোলিউশন + কম অডিও'},
		'subtitle-only': {label: 'শুধু সাবটাইটেল', desc: 'ভিডিও নেই, অডিও নেই, শুধু সাবটাইটেল'}
	},
	playlistPresets: {
		type: {video: 'Video', audio: 'Audio'},
		videoFormat: {best: 'Best codec', mp4: 'MP4 (H.264)'},
		videoFormatDesc: {best: 'প্রতি আইটেমে সর্বোচ্চ উপলব্ধ কোডেক', mp4: 'H.264 + AAC পছন্দ, MP4 কনটেইনার · সর্বোত্তম চেষ্টা'},
		tier: {best: 'Best quality', '2160': '৪K পর্যন্ত', '1440': '১৪৪০p পর্যন্ত', '1080': '১০৮০p পর্যন্ত', '720': '৭২০p পর্যন্ত', '480': '৪৮০p পর্যন্ত', '360': '৩৬০p পর্যন্ত'},
		tierDesc: {best: 'প্রতি আইটেমে সেরা ভিডিও + অডিও', '2160': '২১৬০p-তে সীমিত, প্রতি আইটেমে প্রয়োজনে কমে', '1440': '২K-তে সীমিত, প্রতি আইটেমে প্রয়োজনে কমে', '1080': '১০৮০p-তে সীমিত, প্রতি আইটেমে প্রয়োজনে কমে', '720': 'ছোট ফাইল, বিস্তৃত সামঞ্জস্য', '480': 'Low bandwidth', '360': 'Smallest video'},
		audioFormat: {best: 'Audio (best)', mp3: 'MP3', m4a: 'M4A', opus: 'Opus'},
		audioFormatDesc: {best: 'সেরা নেটিভ অডিও, পুনরায় encode নয়', mp3: 'MP3-তে রূপান্তর', m4a: 'M4A (AAC)-তে রূপান্তর', opus: 'Opus-এ রূপান্তর'},
		audioFormatBitrate: 'Audio ({{format}} {{kbps}}K)',
		mp4Cap: 'YouTube-এ ১০৮০p-এর ওপরে H.264 নেই — স্বয়ংক্রিয়ভাবে ১০৮০p-তে সীমিত'
	},
	formatLabel: {audioFallback: 'অডিও', audioOnlyDot: 'শুধু অডিও · {{audio}}', videoDot: '{{resolution}} · {{audio}}'},
	tray: {tooltip: 'Arroxy', menu: {statusIdle: 'নিষ্ক্রিয়', statusActive_one: '১টি ডাউনলোড হচ্ছে · {{percent}}%', statusActive_other: '{{count}}টি ডাউনলোড হচ্ছে · {{percent}}%', open: 'Arroxy খুলুন', quit: 'Arroxy বন্ধ করুন'}},
	dialogs: {
		quitWithActiveDownloads: {message_one: '{{count}}টি ডাউনলোড চলছে', message_other: '{{count}}টি ডাউনলোড চলছে', detail: 'বন্ধ করলে সমস্ত সক্রিয় ডাউনলোড বাতিল হয়ে যাবে।', confirm: 'ডাউনলোড বাতিল করুন ও বন্ধ করুন', keep: 'ডাউনলোড চালিয়ে যান', pause: 'ডাউনলোড বিরতি দিয়ে বের হন'},
		closeToTray: {message: 'বন্ধ করার সময় Arroxy সিস্টেম ট্রেতে লুকাবে?', detail: 'Arroxy চলতে থাকে এবং সক্রিয় ডাউনলোড শেষ করে। পরে উন্নত সেটিংসে পরিবর্তন করুন।', hide: 'ট্রেতে লুকান', quit: 'বন্ধ করুন', remember: 'আর জিজ্ঞেস করবেন না'},
		rendererCrashed: {message: 'Arroxy একটি সমস্যার সম্মুখীন হয়েছে', detail: 'রেন্ডারার প্রক্রিয়া ক্র্যাশ হয়েছে ({{reason}})। আবার চেষ্টা করতে পুনরায় লোড করুন।', reload: 'পুনরায় লোড করুন', quit: 'বন্ধ করুন'}
	},
	share: {
