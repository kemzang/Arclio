const sr = {
	common: {back: 'Назад', cancel: 'Откажи', continue: 'Настави', retry: 'Покушај поново', startOver: 'Почни испочетка'},
	app: {feedback: 'Повратна информација', logs: 'Дневници', feedbackNudge: 'Свиђа ти се Arroxy? Радо бих чуо твоје мишљење! 💬', debugCopied: 'Копирано!', debugCopyTitle: 'Копирај информације за отклањање грешака (Electron, ОС, верзије Chrome-а)', zoomIn: 'Увећај', zoomOut: 'Умањи'},
	about: {button: 'О апликацији', openTitle: 'О апликацији Arroxy', tagline: 'Брз и пријатан преузимач видеа и звука за рачунар.', websiteLink: 'Веб-сајт', githubLink: 'GitHub', licenseLine: 'Лиценца MIT · by Antonio Orionus', thirdPartyNotices: 'Прикажи обавештења о компонентама трећих страна'},
	titleBar: {close: 'Затвори', minimize: 'Минимизуј', maximize: 'Максимизуј', restore: 'Врати'},
	splash: {greeting: 'Добродошао/ла назад!', warmup: 'Arroxy се покреће…', downloading: 'Преузимање {{binary}}…', warmupFailedNoDiag: 'Подешавање није успело. Отвори дневник подешавања за детаље.'},
	repair: {
	...
	theme: {light: 'Светла тема', dark: 'Тамна тема', system: 'Подразумевана системска'},
	language: {label: 'Језик'},
	wizard: {
		steps: {url: 'URL', playlistItems: 'Playlist', playlistPresets: 'Квалитет', formats: 'Формат', subtitles: 'Титлови', sponsorblock: 'SponsorBlock', output: 'Излаз', folder: 'Сачувај', confirm: 'Потврди'},
		playlist: {
		...
		url: {
			...
			features: {
				...
				youtube: {heading: 'YouTube', video: 'Видеа', channel: 'Канали', playlist: 'Плејлисте', short: 'Shorts', music: 'Музика', podcast: 'Подкасти'},
				anySite: {heading: '2000+ сајтова', video: 'Видеа', videoPlaylist: 'Видео плејлисте', musicPlaylist: 'Музичке плејлисте'},
				always: {heading: 'Увек доступно', audioOnly: 'Само звук', subtitles: 'Титлови'}
			},
			...
			proxy: {label: 'Proxy URL', description: 'Прусмери саобраћај кроз прокси — корисно за географски ограничен садржај.', placeholder: 'http://host:port', clear: 'Обриши'},
			playlistProbeLimit: {
			...
			singleFilenameId: {toggle: 'Додај ID видеа у појединачна имена фајлова', toggleDescription: 'Чува појединачна преузимања јединственим када се наслови промене или поклопе.'},
			networkPacing: {
				...
				presets: {off: 'Искључено', balanced: 'Уравнотежено', careful: 'Пажљиво', custom: 'Прилагођено'},
				tooltips: {
				...
				fields: {sleepRequests: 'Чекање између провера метаподатака', sleepInterval: 'Пауза пре почетка медија: мин', maxSleepInterval: 'Пауза пре почетка медија: макс', sleepSubtitles: 'Чекање пре фајлова титлова', concurrentFragments: 'Везе за преузимање'},
				units: {seconds: 'сек', threads: 'нити'},
				presetLabel: 'Насколько осторожным должен быть Arroxy?'
			},
			closeToTray: {toggle: 'Сакриј у системски трај при затварању', toggleDescription: 'Настави преузимања у позадини после затварања прозора.'},
			analytics: {toggle: 'Пошаљи анонимне статистике коришћења', toggleDescription: 'Броји само покретања апликације. Без URL-ова, имена датотека или личних података.'},
			limitRate: {
		...
		subtitles: {
			...
			saveMode: {heading: 'Сачувај као', sidecar: 'Поред видеа', embed: 'Уграђено у видео', subfolder: 'subtitles/ поддиректоријум'},
			format: {heading: 'Формат'},
		...
		sponsorblock: {
			...
			mode: {off: 'Искључено', mark: 'Означи као поглавља', remove: 'Уклони сегменте'},
			modeHint: {off: 'Без SponsorBlock-а — видео се пушта онако како је отпремљен.', mark: 'Означава спонзорске сегменте као поглавља (неразорно).', remove: 'Исеца спонзорске сегменте из видеа коришћењем FFmpeg-а.'},
		...
		formats: {
			...
			cookiesError: {
				...
				needsCookies: {heading: 'Овај сајт захтева пријаву', body: 'yt-dlp није могао да приступи овом видеу без аутентификације. Подеси cookies у напредним подешавањима — одреди прегледач у ком си већ пријављен или увези cookies.txt датотеку.'},
		...
		folder: {
			...
			custom: 'Прилагођено…',
			subfolder: {toggle: 'Сачувај у поддиректоријум', placeholder: 'нпр. lo-fi rips', invalid: 'Назив директоријума садржи неважеће знакове'}
		},
		output: {
			embedChapters: {label: 'Уграђена поглавља', description: 'Маркери поглавља доступни за навигацију у сваком савременом плејеру.'},
			embedMetadata: {label: 'Уграђени метаподаци', description: 'Наслов, извођач, опис и датум отпремања уписани у датотеку.'},
			embedThumbnail: {label: 'Уграђена сличица', description: 'Насловна слика унутар датотеке. WebM видео ће бити поново мултиплексован у MKV; прескаче се када су титлови уграђени.'},
			writeDescription: {label: 'Сачувај опис', description: 'Чува опис видеа као .description текстуалну датотеку поред преузимања.'},
			writeThumbnail: {label: 'Сачувај сличицу', description: 'Чува сличицу као .jpg датотеку слике поред преузимања.'},
	...
	videoCard: {titlePlaceholder: 'Учитавање…'},
	queue: {
	...
	presets: {
		'best-quality': {label: 'Најбољи квалитет', desc: 'Највиша резолуција + најбољи звук'},
		balanced: {label: 'Уравнотежено', desc: 'Максимум 720p + добар звук'},
		'audio-only': {label: 'Само звук', desc: 'Без видеа, најбољи звук'},
		'small-file': {label: 'Мала датотека', desc: 'Најнижа резолуција + низак квалитет звука'},
		'subtitle-only': {label: 'Само титлови', desc: 'Без видеа, без звука, само титлови'}
	},
	playlistPresets: {
		type: {video: 'Video', audio: 'Audio'},
		videoFormat: {best: 'Best codec', mp4: 'MP4 (H.264)'},
		videoFormatDesc: {best: 'Najviši dostupan kodek po stavci', mp4: 'Prednost H.264 + AAC, MP4 kontejner · najbolji pokušaj'},
		tier: {best: 'Best quality', '2160': 'Do 4K', '1440': 'Do 1440p', '1080': 'Do 1080p', '720': 'Do 720p', '480': 'Do 480p', '360': 'Do 360p'},
		tierDesc: {best: 'Najbolji dostupan video + audio po stavci', '2160': 'Ograničeno na 2160p, pada niže po stavci', '1440': 'Ograničeno na 2K, pada niže po stavci', '1080': 'Ograničeno na 1080p, pada niže po stavci', '720': 'Manji fajlovi, široka kompatibilnost', '480': 'Low bandwidth', '360': 'Smallest video'},
		audioFormat: {best: 'Audio (best)', mp3: 'MP3', m4a: 'M4A', opus: 'Opus'},
		audioFormatDesc: {best: 'Najbolji izvorni audio, bez ponovnog kodiranja', mp3: 'Konvertuj u MP3', m4a: 'Konvertuj u M4A (AAC)', opus: 'Konvertuj u Opus'},
	...
	formatLabel: {audioFallback: 'Звук', audioOnlyDot: 'Само звук · {{audio}}', videoDot: '{{resolution}} · {{audio}}'},
	tray: {tooltip: 'Arroxy', menu: {statusIdle: 'Неактивно', statusActive_one: '1 преузима · {{percent}}%', statusActive_other: '{{count}} преузима · {{percent}}%', open: 'Отвори Arroxy', quit: 'Затвори Arroxy'}},
	dialogs: {
		quitWithActiveDownloads: {message_one: '{{count}} преузимање у току', message_other: '{{count}} преузимања у току', detail: 'Затварање ће отказати сва активна преузимања.', confirm: 'Откажи преузимања и Затвори', keep: 'Настави преузимање', pause: 'Поставить загрузки на паузу и выйти'},
		closeToTray: {message: 'Сакрити Arroxy у системски трај при затварању?', detail: 'Arroxy наставља да ради и завршава активна преузимања. Промени ово касније у Напредним подешавањима.', hide: 'Сакриј у трај', quit: 'Затвори', remember: 'Не питај поново'},
		rendererCrashed: {message: 'Arroxy је наишао на проблем', detail: 'Процес приказивача је пао ({{reason}}). Поново учитај да би покушао/ла поново.', reload: 'Поново учитај', quit: 'Затвори'}
	},
	share: {
		title: 'Подели Arroxy',
