const de = {
	common: {back: 'Zurück', cancel: 'Abbrechen', continue: 'Weiter', retry: 'Erneut versuchen', startOver: 'Von vorn beginnen'},
	app: {feedback: 'Feedback', logs: 'Protokolle', feedbackNudge: 'Gefällt dir Arroxy? Ich freue mich über dein Feedback! 💬', debugCopied: 'Kopiert!', debugCopyTitle: 'Debug-Infos kopieren (Electron-, OS-, Chrome-Versionen)', zoomIn: 'Vergrößern', zoomOut: 'Verkleinern'},
	about: {button: 'Info', openTitle: 'Über Arroxy', tagline: 'Schneller, benutzerfreundlicher Video- und Audio-Downloader für den Desktop.', websiteLink: 'Website', githubLink: 'GitHub', licenseLine: 'MIT-Lizenz · von Antonio Orionus', thirdPartyNotices: 'Drittanbieter-Hinweise anzeigen'},
	titleBar: {close: 'Schließen', minimize: 'Minimieren', maximize: 'Maximieren', restore: 'Wiederherstellen'},
	splash: {greeting: 'Hey, schön dich wiederzusehen!', warmup: 'Arroxy wärmt sich auf…', downloading: '{{binary}} wird heruntergeladen…', warmupFailedNoDiag: 'Einrichtung fehlgeschlagen. Öffne das Einrichtungsprotokoll für Details.'},
	repair: {
	...
	theme: {light: 'Heller Modus', dark: 'Dunkler Modus', system: 'Systemstandard'},
	language: {label: 'Sprache'},
	wizard: {
		steps: {url: 'URL', playlistItems: 'Playlist', playlistPresets: 'Qualität', formats: 'Format', subtitles: 'Untertitel', sponsorblock: 'SponsorBlock', output: 'Ausgabe', folder: 'Speichern', confirm: 'Bestätigen'},
		playlist: {
		...
		url: {
			...
			features: {
				...
				youtube: {heading: 'YouTube', video: 'Videos', channel: 'Kanäle', playlist: 'Playlists', short: 'Shorts', music: 'Musik', podcast: 'Podcasts'},
				anySite: {heading: '2000+ Seiten', video: 'Videos', videoPlaylist: 'Video-Playlists', musicPlaylist: 'Musik-Playlists'},
				always: {heading: 'Immer verfügbar', audioOnly: 'Nur Audio', subtitles: 'Untertitel'}
			},
			...
			proxy: {label: 'Proxy URL', description: 'Datenverkehr über einen Proxy leiten — nützlich für geo-gesperrte Inhalte.', placeholder: 'http://host:port', clear: 'Löschen'},
			playlistProbeLimit: {
			...
			singleFilenameId: {toggle: 'Video-ID zu einzelnen Dateinamen hinzufügen', toggleDescription: 'Hält einzelne Downloads eindeutig, wenn sich Titel ändern oder kollidieren.'},
			networkPacing: {
				...
				presets: {off: 'Aus', balanced: 'Ausgewogen', careful: 'Vorsichtig', custom: 'Benutzerdefiniert'},
				tooltips: {
				...
				fields: {sleepRequests: 'Pause zwischen Metadaten-Abfragen', sleepInterval: 'Pause vor Medienbeginn: Min', maxSleepInterval: 'Pause vor Medienbeginn: Max', sleepSubtitles: 'Pause vor Untertiteldateien', concurrentFragments: 'Download-Verbindungen'},
				units: {seconds: 'Sek', threads: 'Threads'}
			},
			closeToTray: {toggle: 'Beim Schließen in die Taskleiste minimieren', toggleDescription: 'Downloads im Hintergrund fortsetzen, wenn das Fenster geschlossen wird.'},
			analytics: {toggle: 'Anonyme Nutzungsstatistiken senden', toggleDescription: 'Zählt nur App-Starts. Keine URLs, Dateinamen oder persönliche Daten.'},
			limitRate: {
		...
		subtitles: {
			...
			saveMode: {heading: 'Speichern als', sidecar: 'Neben dem Video', embed: 'In Video einbetten', subfolder: 'Unterordner subtitles/'},
		...
		sponsorblock: {
			...
			mode: {off: 'Aus', mark: 'Als Kapitel markieren', remove: 'Segmente entfernen'},
			modeHint: {off: 'Kein SponsorBlock — Video wird unverändert abgespielt.', mark: 'Markiert Sponsor-Segmente als Kapitel (nicht destruktiv).', remove: 'Schneidet Sponsor-Segmente mit FFmpeg aus dem Video.'},
			categoriesHeading: 'Kategorien',
			cat: {sponsor: 'Sponsor', intro: 'Intro', outro: 'Outro', selfpromo: 'Eigenwerbung', music_offtopic: 'Musik (Off-Topic)', preview: 'Vorschau', filler: 'Füllmaterial'}
		},
		formats: {
			...
			cookiesError: {
				...
				needsCookies: {heading: 'Diese Seite erfordert eine Anmeldung', body: 'yt-dlp konnte ohne Authentifizierung nicht auf dieses Video zugreifen. Konfiguriere Cookies in den erweiterten Einstellungen — verweise auf einen Browser, in dem du bereits angemeldet bist, oder importiere eine cookies.txt-Datei.'},
				dpapi: {
		...
		folder: {
			...
			custom: 'Benutzerdefiniert…',
			subfolder: {toggle: 'In Unterordner speichern', placeholder: 'z. B. lo-fi rips', invalid: 'Ordnername enthält ungültige Zeichen'}
		},
		output: {
			embedChapters: {label: 'Kapitel einbetten', description: 'Kapitelmarkierungen, navigierbar in jedem modernen Player.'},
			embedMetadata: {label: 'Metadaten einbetten', description: 'Titel, Künstler, Beschreibung und Upload-Datum in die Datei schreiben.'},
			embedThumbnail: {label: 'Thumbnail einbetten', description: 'Cover-Art in der Datei. WebM-Video wird zu MKV remuxed; wird übersprungen, wenn Untertitel eingebettet werden.'},
			writeDescription: {label: 'Beschreibung speichern', description: 'Speichert die Videobeschreibung als .description-Datei neben dem Download.'},
			writeThumbnail: {label: 'Thumbnail speichern', description: 'Speichert das Thumbnail als .jpg-Bilddatei neben dem Download.'},
			writeM3u: {label: '.m3u-Playlistdatei erstellen', description: 'Speichert eine .m3u-Playlist neben den Videos, damit sie in Reihenfolge im Mediaplayer geöffnet werden.'}
		},
		confirm: {
	...
	videoCard: {titlePlaceholder: 'Wird geladen…'},
	queue: {
	...
	presets: {
		'best-quality': {label: 'Beste Qualität', desc: 'Höchste Auflösung + bestes Audio'},
		balanced: {label: 'Ausgewogen', desc: '720p max + gutes Audio'},
		'audio-only': {label: 'Nur Audio', desc: 'Kein Video, bestes Audio'},
		'small-file': {label: 'Kleine Datei', desc: 'Niedrigste Auflösung + niedriges Audio'},
		'subtitle-only': {label: 'Nur Untertitel', desc: 'Kein Video, kein Audio, nur Untertitel'}
	},
	playlistPresets: {
		type: {video: 'Video', audio: 'Audio'},
		videoFormat: {best: 'Best codec', mp4: 'MP4 (H.264)'},
		videoFormatDesc: {best: 'Höchster verfügbarer Codec pro Eintrag', mp4: 'H.264 + AAC bevorzugt, MP4-Container · bestmöglich'},
		tier: {best: 'Best quality', '2160': 'Bis 4K', '1440': 'Bis 1440p', '1080': 'Bis 1080p', '720': 'Bis 720p', '480': 'Bis 480p', '360': 'Bis 360p'},
		tierDesc: {
		...
		audioFormatDesc: {best: 'Bestes natives Audio, keine Neukodierung', mp3: 'In MP3 umwandeln', m4a: 'In M4A (AAC) umwandeln', opus: 'In Opus umwandeln'},
	...
	formatLabel: {audioFallback: 'Audio', audioOnlyDot: 'Nur Audio · {{audio}}', videoDot: '{{resolution}} · {{audio}}'},
	tray: {tooltip: 'Arroxy', menu: {statusIdle: 'Inaktiv', statusActive_one: '1 lädt herunter · {{percent}}%', statusActive_other: '{{count}} laden herunter · {{percent}}%', open: 'Arroxy öffnen', quit: 'Arroxy beenden'}},
	dialogs: {
		quitWithActiveDownloads: {message_one: '{{count}} Download läuft', message_other: '{{count}} Downloads laufen', detail: 'Beim Schließen werden alle aktiven Downloads abgebrochen.', confirm: 'Downloads abbrechen & beenden', keep: 'Weiter herunterladen', pause: 'Downloads pausieren & beenden'},
		closeToTray: {message: 'Arroxy beim Schließen in den Infobereich minimieren?', detail: 'Arroxy läuft weiter und schließt aktive Downloads ab. Ändern Sie dies in den erweiterten Einstellungen.', hide: 'In Infobereich minimieren', quit: 'Beenden', remember: 'Nicht mehr fragen'},
		rendererCrashed: {message: 'Arroxy hat ein Problem festgestellt', detail: 'Der Renderer-Prozess ist abgestürzt ({{reason}}). Neu laden, um es erneut zu versuchen.', reload: 'Neu laden', quit: 'Beenden'}
	},
	share: {
		title: 'Arroxy teilen',
