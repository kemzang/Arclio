...
- **Опрезни режим** — подесиви пресети темпа (*Искључено · Уравнотежено · Опрезно · Прилагођено*) додају паузе између захтева и ограничавају fragment threads, смањујући шансу за bot-blocks на великим плејлистама
...
Да — и једно и друго. Налепите URL плејлисте или канала (нпр. `youtube.com/@handle`, `/channel/UC…`, `/c/Name`, `/user/Old`); Arroxy набраја до 500 ставки, а затим можете ставити у ред целу листу или бирати поједина видеа. Филтери по опсегу датума и броју стижу ускоро.
...
| Функционалност    | Опис    |
| ---------------- | ---------------- |
| **Филтери плејлисти и канала** | Филтери по опсегу датума и броју приликом набрајања плејлисте или канала (тренутно је ограничење фиксних 500 ставки) |
