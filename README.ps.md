...
Arroxy د [TelemetryDeck](https://telemetrydeck.com) له لارې ناپیژاندل شوې، ټولیزه ټیلیمیټري لیږي — یوازې د یوه مستقل پروژه لپاره د دې لیدلو لپاره کافي چې ایا چا واقعیا کاروي (پیلونه، OS، د اپ نسخه، کریشونه). هیڅ URLs، هیڅ د ویډیو سرلیکونه، هیڅ د فایل لارې، هیڅ د اکاونټ معلومات. د هر نصب ID لیږلو دمخه هیش کیږي او TelemetryDeck هیچکله IPs نه ذخیروي — د EU کوربه تابعیت او د ډیزاین له مخې GDPR-دوستانه. تاسو د تنظیماتو کې لاسپورته کیدای شئ.
