...
| پلیټفارم | بڼه |
| ------------------- | ----------------- |
| 🪟 Windows          | [NSIS نصب کوونکی](https://github.com/antonio-orionus/Arroxy/releases/latest/download/Arroxy-win-x64-Setup.exe) · [پورټیبل `.exe`](https://github.com/antonio-orionus/Arroxy/releases/latest/download/Arroxy-win-x64-Portable.exe) |
