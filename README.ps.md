...
- **احتیاطي حالت** — د تنظیم وړ pacing presets (*بند · متوازن · احتیاطي · دودیز*) چې د غوښتنو ترمنځ ځنډ زیاتوي او fragment threads محدودوي، په درنو پلی‌لېستونو کې د bot-blocks احتمال کموي
...
| ځانګړتیا    | توضیح    |
| ---------------- | ---------------- |
| **د پلیلیسټ او چینل فیلترونه** | کله چې د پلیلیسټ یا چینل شمیرل کوئ د نیټې-سرحد او شمیر فیلترونه (اوس کمپ ثابت ۵۰۰ ننوتنو دی) |
